package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      protected var var_1159:LoaderContext;
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_1159 = new LoaderContext();
         this.var_1159.checkPolicyFile = true;
         ...
         {
            this.var_44.load(param2,this.var_1159);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_363 = 0;
         this.var_44.load(param1,this.var_1159);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_363 < var_3080)
            {
               ...
               this.var_44.load(new URLRequest(this.var_1155 + (this.var_1155.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_363),this.var_1159);
               return true;
            }
         }
         return false;
