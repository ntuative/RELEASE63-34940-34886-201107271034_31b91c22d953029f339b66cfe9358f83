package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1367:String = "AssetLibraryReady";
      
      public static const const_800:String = "AssetLibraryLoaded";
      
      public static const const_1755:String = "AssetLibraryUnloaded";
      
      public static const const_1994:String = "AssetLibraryLoadError";
      ...
      private static var var_1976:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_562:uint = 0;
      
      private static var var_1044:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_563 = new Dictionary(false);
         this.var_1043 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_681 + " doesn\'t contain valid resource class!");
         }
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_681 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1044.splice(var_1044.indexOf(this),1);
            --var_562;
            this.var_563 = null;
            this.var_1043 = null;
            this.var_181 = null;
      ...
      {
         if(this.var_681 == param1.url && this.var_1046)
         {
            if(!this.var_1045 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_680);
            }
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_1043)
         {
            delete this.var_1043[_loc1_];
         }
         if(this.var_44 != null)
         {
            this.var_44.dispose();
         ...
         this.var_1046 = false;
         this.var_681 = null;
         dispatchEvent(new Event(AssetLibrary.const_1755));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1043[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_563[param2.url];
         if(_loc4_ != null)
         {
         ...
         this.var_563[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_563[loader.url];
         if(struct == null)
         {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_563[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return this.var_181[param1] != null || (this.var_680 != null ? this.var_680[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1976.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_680 = _loc2_.resource;
         this.var_681 = _loc2_.url;
         if(this.var_1045)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_680);
         }
            ...
            if(_loc2_ != null)
            {
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_691) && _loc3_.attribute(const_691).toString() == param1)
                  {
                     ...
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_681 + "!");
                     }
                     _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                     _loc5_.setUnknownContent(this.var_680[param1]);
