package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_2055:int = 10000;
       
      
      private var _disposed:Boolean = false;
      
      private var var_89:Socket;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_89 = new Socket();
         this.var_221 = new Timer(const_2055,1);
         this.var_221.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
         this.var_89.addEventListener(Event.CONNECT,this.onConnect);
         this.var_89.addEventListener(Event.COMPLETE,this.onComplete);
         this.var_89.addEventListener(Event.CLOSE,this.onClose);
         this.var_89.addEventListener(ProgressEvent.SOCKET_DATA,this.onRead);
         this.var_89.addEventListener(SecurityErrorEvent.SECURITY_ERROR,this.onSecurityError);
         this.var_89.addEventListener(IOErrorEvent.IO_ERROR,this.onIOError);
         this.var_550 = param3;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_89)
         {
            this.var_89.removeEventListener(Event.CONNECT,this.onConnect);
            this.var_89.removeEventListener(Event.COMPLETE,this.onComplete);
            this.var_89.removeEventListener(Event.CLOSE,this.onClose);
            this.var_89.removeEventListener(ProgressEvent.SOCKET_DATA,this.onRead);
            this.var_89.removeEventListener(SecurityErrorEvent.SECURITY_ERROR,this.onSecurityError);
            this.var_89.removeEventListener(IOErrorEvent.IO_ERROR,this.onIOError);
            if(this.var_1936)
            {
               this.var_89.close();
            }
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         ...
         this.var_89.connect(param1,param2);
         return true;
      }
      ...
      public function removeMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_276.removeConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         if(this.var_89.connected)
         {
            this.var_89.writeBytes(_loc3_);
            this.var_89.flush();
            return true;
         }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_847.getMessages(this.var_551,receivedMessages);
         try
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(this.var_89.bytesAvailable > 0)
         {
            this.var_551.writeByte(this.var_89.readUnsignedByte());
         }
      }
