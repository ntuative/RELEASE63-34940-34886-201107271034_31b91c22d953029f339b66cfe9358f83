package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_706:Map = new Map();
      
      private static const const_391:Map = new Map();
      
      private static var var_1274:Boolean = false;
      ...
      {
         return const_706.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1274)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_706.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1274 = true;
         }
