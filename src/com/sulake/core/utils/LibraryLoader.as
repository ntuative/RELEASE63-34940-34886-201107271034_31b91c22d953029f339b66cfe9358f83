package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2077:uint = 4;
      
      protected static const const_2079:uint = 3;
      
      protected static const name_6:uint = 7;
      
      public static const const_1774:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1379:Boolean = false;
      
      public static const const_1788:int = 2;
      
      private static var var_1000:Array = new Array();
      
      private static var var_819:Array = new Array();
      ...
      protected var var_3069:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1379)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_819[_loc2_] as LibraryLoader;
            ...
            while(var_819.length < const_1788 && false)
            {
               _loc1_ = var_1000.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1153 ? uint(this.var_1424 - this.var_2272) : uint(getTimer() - this.var_2272);
      }
      ...
      {
         if(!this.var_1153 && !_disposed && this.var_1423 > 0)
         {
            try
            {
               this.var_44.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_267,const_1774 - this.var_1423);
            if(this.var_3069)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_515 = LibraryLoader.name_6;
         ...
         if(this.var_515 == LibraryLoader.const_2079)
         {
         ...
         if(this.var_515 == LibraryLoader.name_6)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_680 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_680.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
