package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_2052:String = "float";
      
      public static const const_39:String = "Boolean";
      
      public static const const_1888:String = "bool";
      ...
      private static const const_2124:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         else
         {
            ...
            else if(_loc5_ == const_283 || _loc5_ == const_143)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_2052:
               return Number(param1);
            case const_39:
               return param1 == const_692 || int(param1) > 0;
            case const_1888:
               return param1 == const_692 || int(param1) > 0;
            case const_169:
               return uint(param1);
            case const_143:
               return param1.split(const_1520);
            default:
