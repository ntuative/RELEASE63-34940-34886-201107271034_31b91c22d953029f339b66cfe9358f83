package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_947:IWindowContextStateListener;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_366 = new Array();
            var_366[0] = MouseCursorType.const_328;
            var_366[1] = MouseCursorType.const_30;
            var_366[2] = MouseCursorType.const_328;
            var_366[3] = MouseCursorType.const_328;
            var_366[4] = MouseCursorType.const_328;
            var_366[5] = MouseCursorType.const_30;
            var_366[6] = MouseCursorType.const_328;
         }
         if(var_319 == null)
         {
            var_319 = new Array();
            var_319[0] = WindowState.const_88;
            var_319[1] = WindowState.const_93;
            var_319[2] = WindowState.const_91;
            var_319[3] = WindowState.const_73;
            var_319[4] = WindowState.const_57;
            var_319[5] = WindowState.const_100;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_71 = state.var_1414 as WindowController;
         this.var_192 = state.var_1416 as WindowController;
         this.var_178 = state.renderer;
         this.var_947 = state.var_1415;
         eventQueue.begin();
         this.var_758.x = -1;
         this.var_758.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_758.x || event.stageY != this.var_758.y)
            {
               ...
               array = new Array();
               this.var_96.groupParameterFilteredChildrenUnderPoint(this.var_758,array,WindowParam.const_31);
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_71 && !this.var_71.disposed)
                     {
                        ...
                        {
                           this.var_947.mouseEventReceived(event.type,this.var_71);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1414 = this.var_71;
         state.var_1416 = this.var_192;
         state.renderer = this.var_178;
         state.var_1415 = this.var_947;
      }
