package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_207:String = "regular";
      ...
      private static const const_1652:String = "/*";
      
      private static const const_1653:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_100[const_207],var_100[ITALIC],var_100[BOLD]];
            var_100.reset();
            var_100[const_207] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         {
            while(_loc5_.indexOf(const_1652) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1653) + 2,_loc5_.length);
            }
