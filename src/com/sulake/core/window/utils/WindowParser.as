package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1264:String = "_EXCLUDE";
      
      public static const const_2205:String = "_INCLUDE";
      
      public static const const_2140:String = "_TEMP";
      
      private static const const_1519:String = "layout";
      
      private static const name_7:String = "window";
      
      private static const const_1077:String = "variables";
      
      private static const const_1076:String = "filters";
      
      private static const const_691:String = "name";
      
      private static const const_1526:String = "style";
      
      private static const const_690:String = "params";
      
      private static const const_1527:String = "tags";
      ...
      private static const const_1524:String = "visible";
      
      private static const const_1521:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1352:String = "blend";
      
      private static const const_1528:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1515:String = "treshold";
      
      private static const const_1518:String = "children";
      ...
      private static const const_1516:String = "height_max";
      
      private static const const_692:String = "true";
      
      private static const const_183:String = "0";
      
      private static const const_1523:String = "$";
      
      private static const const_1520:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1517:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1522:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1720:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1425,this.var_1426);
         this.var_1154 = new Dictionary();
         this.var_1720 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1154,this.var_1720);
         this.var_2273 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1522,const_50);
         return param1.replace(const_1517,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1720)
            {
               delete this.var_1720[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1519)
         {
            _loc8_ = param1.child(const_1077);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1076).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         style = uint(this.parseAttribute(xml,const_1526,variables,style));
         params = uint(this.parseAttribute(xml,const_690,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1527,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1524,variables,visible.toString()) == const_692;
         ...
         caption = unescape(String(this.parseAttribute(xml,const_1521,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1520);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1077)[0]),tags) as WindowController;
         ...
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1516,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_692;
         blend = Number(this.parseAttribute(xml,const_1352,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1528,variables,window.clipping.toString()) == const_692;
         ...
         list = xml.child(const_1076).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1264) == -1)
                  {
