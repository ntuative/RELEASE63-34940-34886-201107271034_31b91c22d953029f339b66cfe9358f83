package com.sulake.core.window.utils
{
   ...
   public class TextFieldCache implements IDisposable
   {
      ...
      {
         var _loc2_:TextField = var_1036[param1.name];
         if(_loc2_)
         {
            return _loc2_;
         }
         ...
         if(!param1)
         {
            param1 = TextStyleManager.getStyle(TextStyleManager.const_207);
         }
         ...
         _loc3_.underline = param1.textDecoration == TextStyle.const_915 ? true : null;
