package com.sulake.core.window.services
{
   ...
   public class FocusManager extends ChildEntityArrayReader implements IFocusManagerService
   {
      ...
      private var var_160:Stage;
      
      public function FocusManager(param1:DisplayObject)
      {
         this.var_160 = param1.stage;
         this.var_160.addEventListener(Event.ACTIVATE,this.onActivateEvent);
         this.var_160.addEventListener(FocusEvent.FOCUS_OUT,this.onFocusEvent);
         this.var_160.addEventListener(FocusEvent.KEY_FOCUS_CHANGE,this.onFocusEvent);
         this.var_160.addEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.onFocusEvent);
         super();
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            this.var_160.removeEventListener(Event.ACTIVATE,this.onActivateEvent);
            this.var_160.removeEventListener(FocusEvent.FOCUS_OUT,this.onFocusEvent);
            this.var_160.removeEventListener(FocusEvent.KEY_FOCUS_CHANGE,this.onFocusEvent);
            this.var_160.removeEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.onFocusEvent);
            this.var_160 = null;
            this._disposed = true;
            var_34 = null;
         }
