package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1436:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_945:Number;
      ...
      private var var_491:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_491,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_491 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_491,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_207);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_915 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_491);
      }
      ...
      {
         this.var_945 = param1;
         this._field.scrollH = this.var_945 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_945 * this.maxScrollH,this.var_611 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_491);
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_881,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1346));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1370 ? new PropertyStruct(PropertyDefaults.const_743,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1307) : PropertyDefaults.const_1902);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1283 ? new PropertyStruct(PropertyDefaults.const_1188,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1397) : PropertyDefaults.const_1807);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_973) ? new PropertyStruct(PropertyDefaults.const_455,this._field.textColor,PropertyStruct.const_169,true) : PropertyDefaults.const_1414);
         _loc1_.push(this.var_491 != TextStyleManager.const_207 ? new PropertyStruct(PropertyDefaults.const_458,this.var_491,PropertyStruct.const_53,true,PropertyDefaults.const_760) : PropertyDefaults.const_1353);
         _loc1_.push(this.var_42.left != PropertyDefaults.const_878 ? new PropertyStruct(PropertyDefaults.const_307,this.var_42.left,PropertyStruct.const_36,true) : PropertyDefaults.const_841);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_954 ? new PropertyStruct(PropertyDefaults.const_278,this.var_42.top,PropertyStruct.const_36,true) : PropertyDefaults.const_987);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_994 ? new PropertyStruct(PropertyDefaults.const_306,this.var_42.right,PropertyStruct.const_36,true) : PropertyDefaults.const_907);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_981 ? new PropertyStruct(PropertyDefaults.const_272,this.var_42.bottom,PropertyStruct.const_36,true) : PropertyDefaults.const_958);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1294 ? new PropertyStruct(PropertyDefaults.const_1005,this._field.mouseWheelEnabled,PropertyStruct.const_39,true) : PropertyDefaults.const_1777);
