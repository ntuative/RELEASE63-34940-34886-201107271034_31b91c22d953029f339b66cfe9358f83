package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      override public function dispose() : void
      {
         if(this.var_456)
         {
            this.var_456.removeEventListener(WindowEvent.const_268,this.scrollBarEventProc);
            this.var_456.removeEventListener(WindowEvent.const_310,this.scrollBarEventProc);
            this.var_456 = null;
         }
         if(this.var_1229)
         {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_456)
         {
            ...
            if(this.var_456)
            {
               this.var_456.addEventListener(WindowEvent.const_268,this.scrollBarEventProc);
               this.var_456.addEventListener(WindowEvent.const_310,this.scrollBarEventProc);
            }
         }
         return this.var_456;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_310)
         {
            this.hideScrollBar();
         }
      }
      ...
      {
         return this._itemList.method_1;
      }
      ...
      {
         this._itemList.method_1 = param1;
      }
