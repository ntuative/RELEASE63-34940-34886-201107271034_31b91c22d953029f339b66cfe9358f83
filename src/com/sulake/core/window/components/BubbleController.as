package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2092:String = "_POINTER_UP";
      
      private static const const_2094:String = "_POINTER_DOWN";
      
      private static const const_2093:String = "_POINTER_LEFT";
      
      private static const const_2091:String = "_POINTER_RIGHT";
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_886,this._direction,PropertyStruct.const_53,true));
         }
         else
         {
         ...
         if(this.var_765 != 0)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_910,this.var_765,PropertyStruct.const_36,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_886:
                  ...
                  break;
               case PropertyDefaults.const_910:
