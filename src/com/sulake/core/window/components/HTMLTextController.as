package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1031:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_843:String;
      
      private var var_1266:String = null;
      
      private var var_1929:StyleSheet = null;
      ...
      {
         this.var_843 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1266 == param2)
         {
            return;
         }
         param1.var_1266 = param2;
         param1.var_1929 = null;
         if(param1.var_1266 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1266);
            param1.var_1929 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_811.indexOf(param1) > -1)
         {
            this.var_843 = param1;
         }
      }
      ...
      {
         return this.var_843 == LinkTarget.const_30 ? defaultLinkTarget : this.var_843;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1929;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_843 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_965,this.var_843,PropertyStruct.const_53,true,PropertyDefaults.const_811));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1771);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_965)
            {
               this.var_843 = _loc2_.value as String;
               break;
            }
