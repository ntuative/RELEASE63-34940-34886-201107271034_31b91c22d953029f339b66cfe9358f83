package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1463:String = "increment";
      
      private static const const_1462:String = "decrement";
      
      private static const const_1059:String = "slider_track";
      
      private static const const_684:String = "slider_bar";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_193 = false;
         this.var_17 = param12;
         this._horizontal = param2 == WindowType.const_581;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_17 != null && !this.var_17.disposed)
         {
            ...
            this.var_17.removeEventListener(WindowEvent.const_576,this.onScrollableScrolled);
         }
         this.var_17 = param1;
         if(this.var_17 != null && !this.var_17.disposed)
         {
            this.var_17.addEventListener(WindowEvent.const_40,this.onScrollableResized);
            this.var_17.addEventListener(WindowEvent.const_576,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return findChildByName(const_1059) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_684) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_684:
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_336)
            {
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_46 || param1.type == WindowTouchEvent.const_762)
         {
            if(param2.name == const_1463)
            {
               if(this.var_17)
               {
                  ...
                  {
                     this.scrollV += this.var_17.method_1 / this.var_17.maxScrollV;
                  }
                  this.var_1178 = false;
               }
            }
            else if(param2.name == const_1462)
            {
               if(this.var_17)
               {
                  this.var_1178 = true;
            ...
            else if(param2.name == const_1059)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_684).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
               ...
               {
                  this.scrollV -= (this.var_17.visibleRegion.height - this.var_17.method_1) / this.var_17.maxScrollV;
               }
         ...
         if(param1.type == WindowMouseEvent.const_336)
         {
