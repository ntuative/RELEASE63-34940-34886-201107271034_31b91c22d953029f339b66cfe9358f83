package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_491);
         if(_loc1_)
         {
      ...
      {
         if(this.var_491 != param1.name)
         {
            this.var_491 = param1.name;
            this.refresh();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_391 != _loc2_.color : this.var_391 != null && this.var_391 != PropertyDefaults.const_973) ? new PropertyStruct(PropertyDefaults.const_455,this.var_391,PropertyStruct.const_169,true) : PropertyDefaults.const_1414);
         if(this.var_42)
         {
            if(this.var_42.left != PropertyDefaults.const_878)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_307,this.var_42.left,PropertyStruct.const_36,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_841);
            }
            if(this.var_42.top != PropertyDefaults.const_954)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_278,this.var_42.top,PropertyStruct.const_36,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_987);
            }
            if(this.var_42.right != PropertyDefaults.const_994)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_306,this.var_42.right,PropertyStruct.const_36,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_907);
            }
            if(this.var_42.bottom != PropertyDefaults.const_981)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_272,this.var_42.bottom,PropertyStruct.const_36,true));
            }
            else
            {
