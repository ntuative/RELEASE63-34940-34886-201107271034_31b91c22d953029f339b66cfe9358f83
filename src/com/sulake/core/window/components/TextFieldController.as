package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1395,var_10);
         }
         return var_21;
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_961,false,PropertyStruct.const_39,true) : PropertyDefaults.const_1940);
         _loc1_.push(this.var_1421 != PropertyDefaults.const_1318 ? new PropertyStruct(PropertyDefaults.const_817,this.var_1421,PropertyStruct.const_39,true) : PropertyDefaults.const_1904);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1406 ? new PropertyStruct(PropertyDefaults.const_891,_field.selectable,PropertyStruct.const_39,true) : PropertyDefaults.const_1812);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1180 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_39,true) : PropertyDefaults.const_1923);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_961:
                  ...
                  break;
               case PropertyDefaults.const_1327:
