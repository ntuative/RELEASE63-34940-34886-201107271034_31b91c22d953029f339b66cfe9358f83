package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1493:String = "_SELECTOR";
      
      private static const const_1492:String = "_CONTENT";
       
      
      protected var var_1151:ITabSelectorWindow;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1151 = findChildByTag(const_1493) as ITabSelectorWindow;
            if(this.var_1151 != null)
            {
               this.var_1151.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2270 = findChildByTag(const_1492) as IWindowContainer;
         }
      ...
      {
         return this.var_1151.numSelectables;
      }
