package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         this.var_1723 = PropertyDefaults.const_764;
         this.var_1430 = PropertyDefaults.const_419;
         param4 |= 0;
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_419)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_419)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_778,param1.toolTipCaption,PropertyStruct.const_53,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_2044);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_764)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_934,param1.toolTipDelay,PropertyStruct.const_285,true));
         }
         else
         {
