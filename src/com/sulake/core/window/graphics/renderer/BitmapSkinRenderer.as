   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_809.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_809.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_809.blueMultiplier = (param1.color & 255) / 255;
               this.var_809.alphaMultiplier = 1;
            }
            _loc17_ = 0;
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_809);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_360 == SkinLayoutEntity.const_352)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_360 == SkinLayoutEntity.const_550)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_360 == SkinLayoutEntity.const_378)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  else if(_loc10_.var_360 == SkinLayoutEntity.const_546)
                  {
                     REGION.x = param3.width / 2 - 0;
                  }
                  if(_loc10_.var_359 == SkinLayoutEntity.const_352)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_359 == SkinLayoutEntity.const_550)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_359 == SkinLayoutEntity.const_378)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_359 == SkinLayoutEntity.const_546)
                  {
                  ...
                  else if(_loc10_.var_359 == SkinLayoutEntity.const_378 || _loc10_.var_360 == SkinLayoutEntity.const_378)
                  {
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_360 == SkinLayoutEntity.const_352)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_359 == SkinLayoutEntity.const_352)
               {
