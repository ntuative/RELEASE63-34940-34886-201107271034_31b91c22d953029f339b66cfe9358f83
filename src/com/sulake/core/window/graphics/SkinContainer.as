package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1171:uint = 8;
      
      private static const const_1715:String = "skin";
      
      private static const const_1717:String = "bitmap";
      
      private static const const_1714:String = "fill";
      
      private static const const_1713:String = "text";
      
      private static const const_1716:String = "label";
      
      private static const const_1712:String = "shape";
      ...
      private var var_2986:Dictionary;
      
      private var var_2987:Dictionary;
      
      private var var_2988:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2986 = new Dictionary();
         TypeCodeTable.fillTables(this.var_2173,this.var_2986);
         this.var_2987 = new Dictionary();
         this.var_2988 = new Dictionary();
         StateCodeTable.fillTables(this.var_2987,this.var_2988);
         this.var_493 = new Dictionary();
         this.var_493[const_1715] = BitmapSkinRenderer;
         this.var_493[const_1717] = BitmapDataRenderer;
         this.var_493[const_1714] = FillSkinRenderer;
         this.var_493[const_1713] = TextSkinRenderer;
         this.var_493[const_1716] = LabelRenderer;
         this.var_493[const_1712] = ShapeSkinRenderer;
         this.var_493[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_493[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_367 == null)
         {
            var_367 = new Array();
            var_367.push(WindowState.const_73);
            var_367.push(WindowState.const_94);
            var_367.push(WindowState.const_100);
            var_367.push(WindowState.const_57);
            var_367.push(WindowState.const_91);
            var_367.push(WindowState.const_93);
            var_367.push(WindowState.const_88);
            var_367.push(WindowState.const_107);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_2173[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_1131[param1] = new Array(const_1171);
         }
         this.var_1131[param1][param2] = param3;
         if(this.var_1132[param1] == null)
         {
            this.var_1132[param1] = new Array(const_1171);
         }
         this.var_1132[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1131[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1132[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_106)
