package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_107:String = "ErrorEvent";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_360 = SkinLayoutEntity.const_573;
                  break;
               case "move":
                  _loc5_.var_360 = SkinLayoutEntity.const_352;
                  break;
               case "strech":
                  _loc5_.var_360 = SkinLayoutEntity.const_550;
                  break;
               case "tiled":
                  _loc5_.var_360 = SkinLayoutEntity.const_378;
                  break;
               case "center":
                  _loc5_.var_360 = SkinLayoutEntity.const_546;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_359 = SkinLayoutEntity.const_573;
                  break;
               case "move":
                  _loc5_.var_359 = SkinLayoutEntity.const_352;
                  break;
               case "strech":
                  _loc5_.var_359 = SkinLayoutEntity.const_550;
                  break;
               case "tiled":
                  _loc5_.var_359 = SkinLayoutEntity.const_378;
                  break;
               case "center":
                  _loc5_.var_359 = SkinLayoutEntity.const_546;
            }
         }
