package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1661:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_186:IProfiler;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_186)
         {
            this.var_186.removeStopEventListener(this.refresh);
            this.var_186 = null;
         }
         if(!this.var_186 && param1)
         {
            this.var_186 = param1;
            this.var_186.addStopEventListener(this.refresh);
         }
      }
      ...
      {
         var _loc2_:Array = this.var_186.getProfilerAgentsInArray();
         ...
         if(this.var_2120)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_186.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_186.numBitmapAssetInstances + " / " + this.var_186.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this._windowRenderer.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_186.numTrackedBitmapDataInstances + " / " + this.var_186.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1661() as ByteArray;
