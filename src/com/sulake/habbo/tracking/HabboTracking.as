package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1172:uint = 11;
      ...
      private var var_1384:IHabboWindowManager;
      ...
      private var var_308:PerformanceTracker = null;
      
      private var var_497:FramerateTracker = null;
      
      private var var_307:LatencyTracker = null;
      
      private var var_745:LagWarningLogger = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_308 = new PerformanceTracker();
         this.var_497 = new FramerateTracker();
         this.var_307 = new LatencyTracker();
         this.var_745 = new LagWarningLogger();
         this.var_496 = new ToolbarClickTracker(this);
         this.var_1690 = new Array(const_1172);
         var _loc4_:int = 0;
         while(_loc4_ < const_1172)
         {
            this.var_1690[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_2063,new Date().getTime().toString());
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_2019,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_970,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1306,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1384)
            {
               this.var_1384.release(new IIDHabboWindowManager());
               this.var_1384 = null;
            }
            if(this.var_343)
            {
            ...
            if(this.var_234)
            {
               if(!this.var_234.disposed)
               {
                  ...
                  Component(this.var_234).events.removeEventListener(HabboFriendListTrackingEvent.const_596,this.onFriendlistTrackingEvent);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_144)
         {
            if(this.var_307 != null)
            {
               this.var_307.configuration = this.var_144;
            }
            if(this.var_308 != null)
            {
               this.var_308.configuration = this.var_144;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1819);
            if(this.var_144)
            {
               if(this.var_745 != null)
               {
                  this.var_745.configure(this.var_144);
               }
               if(this.var_497 != null)
               {
                  this.var_497.configure(this.var_144);
               }
               if(this.var_496 != null)
               {
                  this.var_496.configure(this.var_144);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_905,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_76,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_540,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_308 != null)
            {
               this.var_308.connection = param1;
            }
            if(this.var_307 != null)
            {
               this.var_307.communication = this._communication;
               this.var_307.connection = param1;
            }
            if(this.var_745 != null)
            {
               this.var_745.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_905)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1968);
         }
         else if(param1.type == HabboHotelViewEvent.const_540)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1867);
         }
         else if(param1.type == HabboHotelViewEvent.const_76)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1874);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_782:
               this.trackLoginStep(HabboLoginTrackingStep.const_1840,String(this._communication.port));
               break;
      ...
      {
         this.var_1384 = IHabboWindowManager(param2);
         if(this.var_1384)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_144)
            {
               if(this.var_144.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1690)
                  {
                  ...
                  if(this.var_308 != null)
                  {
                     _loc4_["null"] = this.var_308.flashVersion;
                     _loc4_["null"] = this.var_308.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1329);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1329,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_234).events.addEventListener(HabboFriendListTrackingEvent.const_596,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_596:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1306,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_970,String(true));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_343.events.addEventListener(AdEvent.const_622,this.onRoomAdLoad);
      }
      ...
      private function onRoomAction(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_350)
         {
            if(this.var_355)
            {
               this.var_355.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_497)
               {
                  ...
                  this.trackEventLog("Performance","fps",String(this.var_497.frameRate),_loc2_);
                  ++this.var_2177;
               }
            }
         }
      ...
      {
         this.var_745.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_598 > -1 && _loc2_ < this.var_598)
         {
            ++this.var_2176;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_2176);
         }
         if(this.var_598 > -1 && _loc2_ - this.var_598 > 15000)
         {
            ++this.var_2178;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_2178);
         }
         this.var_598 = _loc2_;
         if(this.var_308 != null)
         {
            this.var_308.update(param1,this.var_598);
         }
         if(this.var_307 != null)
         {
            this.var_307.update(param1,this.var_598);
         }
         if(this.var_497 != null)
         {
            this.var_497.trackUpdate(param1,this,this.var_598);
         }
         if(this.var_745 != null)
         {
            this.var_745.update(this.var_598);
         }
      }
   }
}
