package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1742:int = 10;
      
      private static const const_1177:int = 100;
      
      private static const const_1743:int = 20;
       
      
      private var var_158:HabboMessenger;
      
      private var var_3011:IScrollbarWindow;
      
      private var var_2189:IContainerButtonWindow;
      
      private var var_63:IItemListWindow;
      
      private var var_599:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_158 = param1;
         this.var_2189 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_63 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_3011 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1177 + const_1743)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1742;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_599 == null || _loc1_.id != this.var_599.id)
         {
            this.var_599 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_599.followingAllowed)
         {
            this.var_2189.enable();
         }
         else
         {
            this.var_2189.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_63.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_599.messages.length - const_1177);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_599.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_599.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_1011 || param3.type == Message.const_771 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_599.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_158.send(new FollowFriendMessageComposer(this.var_599.id));
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_943)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1284)
         {
            return 4288269465;
         }
         return 4291611852;
