package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_503:Conversations;
      ...
      {
         if(this._windowManager && this._communication && this.var_144 && this._localization && this._friendList && this.var_608 && this._soundManager)
         {
            unlock();
      ...
      {
         this.var_503 = new Conversations(new ConversationsDeps(this));
      ...
      {
         var _loc2_:Conversation = this.var_503.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         {
            this.var_503.setSelected(_loc2_);
      ...
      {
         return !!this.var_503 ? this.var_503.findSelectedConversation() : null;
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_503.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_503.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_771,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1284,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_503.addMessageAndUpdateView(param1);
         if(!this.var_211.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1259,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         this.var_503.addMessageAndUpdateView(_loc3_);
      }
