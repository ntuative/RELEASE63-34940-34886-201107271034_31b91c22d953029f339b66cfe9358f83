package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      {
         this.var_22.showUI(HabboHelpViewEnum.const_452);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         this.var_22.showUI(HabboHelpViewEnum.const_554);
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            this.var_22.tellUI(HabboHelpViewEnum.const_290,_loc4_);
         }
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         this.var_22.showUI(HabboHelpViewEnum.const_1411);
         this.var_22.tellUI(HabboHelpViewEnum.const_1411,_loc5_);
      }
