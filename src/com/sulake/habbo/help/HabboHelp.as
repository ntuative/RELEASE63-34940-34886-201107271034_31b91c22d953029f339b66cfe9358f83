package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_313:IHabboLocalizationManager;
      
      private var var_943:IHabboConfigurationManager;
      ...
      private var var_1669:CallForHelpData;
      
      private var var_2920:UserRegistry;
      
      private var var_2784:String = "";
      
      private var var_1115:WelcomeScreenController;
      
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1669 = new CallForHelpData();
         this.var_2920 = new UserRegistry();
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return this.var_943.getKey(param1,param2,param3);
      }
      ...
      {
         this.var_1669.reportedUserId = param1;
         this.var_1669.reportedUserName = param2;
         this.var_76.showUI(HabboHelpViewEnum.const_452);
      }
      ...
      public function startNameChange() : void
      {
         if(this.var_125)
         {
            this.var_125.showView(TutorialUI.const_338);
         }
      }
      ...
      {
         this.var_313 = IHabboLocalizationManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),this.onConfigurationManagerReady);
      }
      
      private function onConfigurationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_943 = IHabboConfigurationManager(param2);
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         if(!this.var_1115)
         {
            this.var_1115 = new WelcomeScreenController(this,this._windowManager);
         }
         this.var_1115.showWelcomeScreen(param1);
      }
