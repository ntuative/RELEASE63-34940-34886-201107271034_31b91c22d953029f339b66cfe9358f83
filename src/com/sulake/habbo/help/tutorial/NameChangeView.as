package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1460:uint = 13232628;
      ...
      private var var_1174:NameSuggestionListRenderer;
      ...
      private function showSelectionView() : void
      {
         if(!this.var_777)
         {
            this.var_777 = this.var_27.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_777)
            {
               return;
            }
            this._window.content.addChild(this.var_777);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_778)
         {
            this.var_778 = this.var_27.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_778)
            {
               return;
            }
            this._window.content.addChild(this.var_778);
         }
         this._window.caption = this.var_27.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_778.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_522;
         }
         this.showView(this.var_778);
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1147 || param1 == ChangeUserNameResultMessageEvent.var_1146)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1174 = new NameSuggestionListRenderer(this.var_27);
         var _loc6_:int = this.var_1174.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1460;
