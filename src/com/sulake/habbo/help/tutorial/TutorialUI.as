package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_431:String = "TUI_CLOTHES_VIEW";
      
      public static const const_664:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_648,this.onTaskDoneEvent);
         ...
         {
            this.var_36.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_367,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1341 && this.var_1340 && this.var_1641;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_36)
         {
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_648,this.onTaskDoneEvent);
            ...
            if(this.var_36.sessionDataManager != null)
            {
               this.var_36.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_367,this.onFigureUpdate);
            }
            this.var_36 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_648:
               this.var_1641 = true;
               if(this.var_53 != null && this.var_53.id == const_664)
               {
                  this.showView(const_98);
               }
               break;
            case HabboHelpTutorialEvent.const_663:
               if(this.var_53 != null && this.var_53.id == const_431)
               {
                  this.var_2080 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2867 = this._window.width - _loc2_.width;
         ...
         this._window.height = _loc2_.height + this.var_2866;
         this._window.width = _loc2_.width + this.var_2867;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_36.hideUI();
         this.var_36.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_134));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_53 != null && (this.var_53.id == const_338 || this.var_53.id == const_98))
         {
            this.showView(const_98);
         }
      }
      ...
      {
         this.var_1341 = true;
         if(this.var_53 != null && (this.var_53.id == const_431 || this.var_53.id == const_98))
         {
            this.showView(const_98);
         }
      }
