package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2112:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201107271028));
         this.var_143 = new Map();
         this.var_143.add(HabboHelpViewEnum.const_2034,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_143.add(HabboHelpViewEnum.const_224,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_143.add(HabboHelpViewEnum.const_554,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_143.add(HabboHelpViewEnum.const_354,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_143.add(HabboHelpViewEnum.const_290,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_143.add(HabboHelpViewEnum.const_452,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_143.add(HabboHelpViewEnum.const_1002,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_143.add(HabboHelpViewEnum.const_286,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_143.add(HabboHelpViewEnum.const_1301,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_143.add(HabboHelpViewEnum.const_1201,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_143.add(HabboHelpViewEnum.const_969,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_143.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_143.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_584.length == 0 || param1 != this.var_414)
            {
               this.var_584.push(this.var_414);
            }
         }
         this.var_414 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_286:
               this.showUI(HabboHelpViewEnum.const_286);
               break;
            case CallForHelpResultEnum.const_1235:
               this.showUI(HabboHelpViewEnum.const_1201);
               break;
            case CallForHelpResultEnum.const_1202:
               this.showUI(HabboHelpViewEnum.const_1301);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_143.getValue(HabboHelpViewEnum.const_224) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_648));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = this.var_143.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_143.getValue(this.var_414);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2867 = this._window.width - _loc3_.width;
         this.var_2866 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2866;
         this._window.width = _loc1_.width + this.var_2867;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_584.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_414 == HabboHelpViewEnum.const_224)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_414 == HabboHelpViewEnum.const_224 || this.var_584.length == 0)
         {
            return;
         }
         if(this.var_413 == null)
