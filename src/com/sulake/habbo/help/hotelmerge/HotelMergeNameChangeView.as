package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_777)
         {
            this.var_777 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_777)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_778)
         {
            this.var_778 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_778)
            {
               return;
            }
