package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1531:uint = 1;
      ...
      private var var_1862:ProfilerOutput;
      
      private var var_1502:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_218 = new Array(const_474);
         ...
         this.var_696 = this.var_218[const_1531];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1862)
            {
               this.var_1862 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1862.profiler = _loc3_;
            this.var_1502 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1502);
      ...
      {
         return this.var_696.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_696.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this.var_218[param1].getDesktopWindow().getChildAt(this.var_696.getDesktopWindow().numChildren - 1);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1993,new Date().getTime().toString());
