package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1180:IDropMenuWindow;
      
      private var var_524:ITextFieldWindow;
      
      private var _disposed:Boolean;
      
      private var var_644:Boolean = true;
      
      private var var_968:OffenceCategoryData;
      
      private var var_967:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1181 = IButtonWindow(this.var_36.getXmlWindow("modact_offence"));
         this.var_1179 = IButtonWindow(this.var_36.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1777;
         ...
         this.var_524 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_524.procedure = this.onInputClick;
         this.var_1180 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1180);
      ...
      public function refreshCategorization() : void
      {
         ...
         {
            this._frame.findChildByName("offence_txt").caption = this.var_967.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_968 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_968.offences,this.var_1181,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_36.initMsg.offenceCategories,this.var_1179,this.onOffenceCtgButton);
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModAlertMessageComposer(this.var_1466,this.var_524.text,this.var_1465));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_968 = this.var_36.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_967 = this.var_968.offences[_loc3_];
         this.var_524.text = this.var_967.msg;
         this.var_644 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModKickMessageComposer(this.var_1466,this.var_524.text,this.var_1465));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1180.selection < 0)
         {
            this.var_36.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_36.connection.send(new ModBanMessageComposer(this.var_1466,this.var_524.text,this.getBanLength(),this.var_1465));
         this.dispose();
      }
      
      private function isMsgGiven() : Boolean
      {
         if(this.var_644 || this.var_524.text == "")
         {
      ...
      {
         var _loc1_:int = this.var_1180.selection;
      ...
      {
         if(param1.type != WindowEvent.const_337)
         {
            return;
         }
         if(!this.var_644)
