package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_567:UserInfoCtrl;
      
      private var var_1290:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_567 = new UserInfoCtrl(this._window,this.var_75,_loc3_.message);
         this.var_1290 = new UserInfoCtrl(this._window,this.var_75,_loc3_.message);
         this.var_567.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1290.load(_loc4_,this.var_185.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_75.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_75,WindowTracker.const_1325,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_567 = new UserInfoCtrl(this._window,this.var_75,_loc3_.message);
            this.var_567.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
