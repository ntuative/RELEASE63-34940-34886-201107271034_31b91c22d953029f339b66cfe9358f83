package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1870:int = 200;
      ...
      {
         this.var_824 = IWindowContainer(this.var_36.getXmlWindow("roomvisits_row"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         ...
         return IWindowContainer(this.var_824.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_1003.length < var_1870)
         {
            ...
            param1.width = this.var_824.width;
            param1.height = this.var_824.height;
