package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1868:IIssueBrowserView;
      
      private var var_1869:IIssueBrowserView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_287 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_287.numTabItems)
            {
               _loc5_ = this.var_287.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_48,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_287 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_287 == null || this.var_287.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_287.selector.getSelectableByName("open_issues");
         this.var_287.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_381.view.width = this.var_287.container.width;
         this.var_381.view.height = this.var_287.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2379:
               ...
               {
                  this.var_1868 = new MyIssuesView(this.issueManager,this,this.var_287.container);
               }
               return this.var_1868;
            case this.const_2377:
               if(this.var_1869 == null)
               {
                  this.var_1869 = new OpenIssuesView(this.issueManager,this,this.var_287.container);
               }
               return this.var_1869;
            case this.const_2378:
               if(this.var_1867 == null)
               {
                  this.var_1867 = new PickedIssuesView(this.issueManager,this,this.var_287.container);
               }
