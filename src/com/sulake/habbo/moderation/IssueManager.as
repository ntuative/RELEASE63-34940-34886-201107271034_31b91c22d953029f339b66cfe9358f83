package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1217:String = "issue_bundle_open";
      
      public static const const_1012:String = "issue_bundle_my";
      
      public static const const_1261:String = "issue_bundle_picked";
      
      public static const const_1834:int = 15000;
       
      
      private var var_75:ModerationManager;
      
      private var var_650:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_650 = new IssueBrowser(this,this.var_75.windowManager,this.var_75.assets);
         this.var_1230 = [];
         this.var_1231 = [];
         this.var_999 = new Map();
         this.var_2500 = parseInt(this.var_75.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1850 = new Timer(const_1834,0);
         this.var_1850.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1850.start();
      }
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_396 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_650 == null || !this.var_650.isOpen())
         {
            this.var_75.soundManager.playSound(HabboSoundTypesEnum.const_1347);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1817)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         ...
         if(this.var_1230.indexOf(param1.issueId) != -1)
         {
            ...
            {
               if(param1.state == IssueMessageData.const_396)
               {
         ...
         {
            _loc6_ = this.getBundles(const_1012);
            _loc7_ = false;
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2500);
            }
         }
         ...
         for each(_loc4_ in this.var_122)
         {
            switch(param1)
            {
               case const_1217:
                  ...
                  break;
               case const_1012:
                  if(_loc4_.state == IssueMessageData.const_396 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_396 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
