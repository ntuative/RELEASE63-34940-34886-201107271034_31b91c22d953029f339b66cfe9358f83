package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1142:Array = [];
      
      private static var var_2211:int = 1000;
      
      private static var var_1141:Array = [];
      
      private static var var_2209:int = 200;
      ...
      private var var_2168:IMessageComposer;
      ...
      {
         this.var_926 = IWindowContainer(this.var_36.getXmlWindow("chatlog_roomheader"));
         this.var_927 = IWindowContainer(this.var_36.getXmlWindow("chatlog_chatline"));
         ...
         this.var_36.connection.send(this.var_2168);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1142.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_927.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1142.length < var_2211)
         {
            ...
            param1.width = this.var_927.width;
            param1.height = this.var_927.height;
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1141.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_926.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1141.length < var_2209)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_926.width;
            param1.height = this.var_926.height;
            var_1141.push(param1);
         }
         else
         {
            param1.dispose();
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_2210[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1707.getValue(param2.chatterName))
            {
               this.var_1707.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1707.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1706)
         {
            this.storeChatLineWindow(_loc1_);
         }
         for each(_loc1_ in this.var_1705)
         {
