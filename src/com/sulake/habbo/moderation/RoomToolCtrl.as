package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function show() : void
      {
         ...
         this.var_36.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_404));
         Logger.log("BEGINNING TO SHOW: " + this.var_404);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1918;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_404);
         if(param1.flatId != this.var_404)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_404);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1516 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1515 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function act(param1:Boolean) : void
      {
         ...
         this.var_36.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1971,_loc2_,this.var_524.text,"",""));
         if(this.var_1516.isSelected || this.var_1515.isSelected || this.var_1008.isSelected)
         {
            this.var_36.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1516.isSelected,this.var_1515.isSelected,this.var_1008.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1920);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1770);
      }
