package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1346:BitmapData = null;
      
      private var var_1345:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2891 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2889 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2890 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_2093 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_2093 > 0 && this.var_2092 >= this.var_2093)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1344;
         if(_loc1_ > this.var_2889)
         {
            ++this.var_2092;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1646 = _loc2_.imageUrl;
         this.var_2888 = _loc2_.clickUrl;
         this.var_1344 = getTimer();
         if(this.var_1646 != "")
         {
            _loc3_ = this.var_1646;
            ...
            {
               this.var_260 = new Timer(this.var_2890,1);
            ...
            this.var_260.start();
            _loc4_ = new URLRequest(this.var_1646);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_660,param1.bitmapData,this.var_2888));
            this.var_1344 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_590));
         }
      }
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_) && this.var_410 != null)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_622,this.var_410.roomId,this.var_410.roomCategory,_loc4_,_loc2_.assetName,this.var_410.clickURL,this.var_1346,this.var_1345));
            this.var_410 = null;
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1346 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1345 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:int, param3:int, param4:int, param5:int, param6:String, param7:String) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_780,param2,param3,param1,param6,param7,null,null,param4,param5));
         }
      }
