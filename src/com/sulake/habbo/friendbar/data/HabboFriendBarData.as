package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1063:Boolean = false;
      
      private static const const_687:String = "Navigation";
      
      private static const const_686:String = "Friend Bar";
      
      private static const const_1489:String = "go.friendbar";
      
      private static const const_1490:String = "chat_btn_click";
      
      private static const const_1488:String = "find_friends_btn_click";
      
      private static const const_1066:String = "Toolbar";
      
      private static const const_1065:String = "open";
      
      private static const const_1064:String = "close";
      
      private static const const_1487:String = "FRIENDLIST";
      
      private static const const_1491:String = "MESSENGER";
       
      
      private var var_988:IHabboConfigurationManager;
      ...
      private var var_378:IHabboEventStream;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_988)
            {
               this.var_988.release(new IIDHabboConfigurationManager());
               this.var_988 = null;
            }
            if(this.var_93)
            {
            ...
            if(this.var_83)
            {
               if(!this.var_83.disposed)
               {
                  ...
                  this.var_83.events.removeEventListener(FriendRequestEvent.const_235,this.onFriendRequestEvent);
               }
            ...
            if(this.var_378)
            {
               this.var_378.release(new IIDHabboEventStream());
               this.var_378 = null;
            }
            this.var_111 = null;
      ...
      {
         return this.var_335.getValue(param1);
      }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_93)
         {
            ...
            this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_687,const_686,const_1489));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_216)
         {
            ...
            if(this.var_93)
            {
               this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_687,const_686,const_1490));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_93)
         {
            ...
            this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_687,const_686,const_1488));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_83)
         {
            if(!this.var_83.disposed)
            {
               ...
               if(this.var_93)
               {
                  this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1066,const_1487,!!this.var_83.isOpen() ? const_1065 : const_1064));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_216)
         {
            if(!this.var_216.disposed)
            {
               ...
               if(this.var_93)
               {
                  this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1066,const_1491,!!this.var_216.isOpen() ? const_1065 : const_1064));
               }
            }
         }
      }
      ...
      public function toggleOfflineStream() : void
      {
         if(this.var_378)
         {
            ...
            {
               this.var_378.visible = !this.var_378.visible;
            }
         }
      }
      ...
      public function refreshOfflineStream() : void
      {
         if(this.var_378)
         {
            if(!this.var_378.disposed)
            {
               this.var_378.refreshEventStream();
            }
         }
      }
      ...
      {
         this.var_988 = param2 as IHabboConfigurationManager;
         this.var_2437 = this.var_988.getBoolean("friendbar.notifications.enabled",false);
         this.var_1812 = this.var_988.getBoolean("friendbar.requests.enabled",false);
      }
      ...
      {
         this.var_378 = param2 as IHabboEventStream;
      }
      ...
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_83.events.addEventListener(FriendRequestEvent.const_235,this.onFriendRequestEvent);
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_335.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_335.remove(_loc8_);
               this.var_111.splice(this.var_111.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_335.getValue(_loc4_.id);
            if(_loc3_)
            {
            ...
            else if(_loc4_.online || const_317)
            {
               ...
               this.var_335.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_317)
            {
               if(this.var_335.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_805));
            this.makeNotification(String(this.var_805),FriendNotification.const_409,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_805));
            this.makeNotification(String(this.var_805),FriendNotification.const_409,null,true,false);
         }
      }
