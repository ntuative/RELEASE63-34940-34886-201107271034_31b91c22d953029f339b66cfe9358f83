package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1551:String = "entity_xml";
      
      private static const const_1550:String = "facebook_piece_xml";
      
      private static const const_1552:String = "controls_piece_xml";
      
      protected static const const_1044:String = "pieces";
      
      protected static const const_385:String = "icons";
      
      protected static const const_464:String = "header";
      
      protected static const const_1430:String = "facebook";
      ...
      protected static const const_1045:String = "icon_message";
      
      protected static const const_1431:String = "btn_visit";
      
      protected static const ICON:String = "icon";
      
      protected static const const_1049:String = "label";
      
      protected static const const_497:String = "notification";
      
      private static const const_75:uint = 10338138;
      
      private static const const_1084:uint = 13891476;
      
      private static const const_1085:String = null;
      
      private static const const_696:String = "icon_tag_notify";
      
      private static const const_1553:String = "icon_tag_message";
      
      private static const POOL:Vector.<FriendEntityTab> = new Vector.<FriendEntityTab>();
      
      private static const const_475:Vector.<IWindowContainer> = new Vector.<IWindowContainer>();
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:IItemListWindow = IItemListWindow(param1.getChildByName(const_1044));
         _loc3_ = _loc2_.getListItemByName(const_1430) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            _loc2_ = IItemListWindow(window.getChildByName(const_1044));
            _loc5_ = false;
            if(this.friend.realName != null && this.friend.realName != "")
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1550).content as XML) as IWindowContainer;
               _loc3_.name = const_1430;
               _loc6_ = _loc3_.getChildByName(const_691) as ITextWindow;
               _loc6_.caption = this.friend.realName;
               if(!_loc6_.wordWrap)
               {
                  var_2243.crop(_loc6_);
               }
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1552).content as XML) as IWindowContainer;
               ...
               _loc8_ = _loc3_.getChildByName(const_1431);
               if(_loc8_)
               {
      ...
      {
         super.expose();
         _window.color = !!exposed ? uint(const_1084) : uint(const_75);
         ITextWindow(_window.findChildByTag(const_1049)).underline = exposed;
      }
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_169)
         {
            ...
            _loc1_ = IItemListWindow(_window.getChildByName(const_1044)).getListItemByName(const_464) as IWindowContainer;
            _loc1_.findChildByName(const_691).caption = this.var_169.name;
            var_2243.crop(_loc1_.getChildByName(const_691) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_316));
            _loc2_.bitmap = var_508.getAvatarFaceBitmap(this.var_169.figure);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_475.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1551).content as XML) as IWindowContainer;
            ...
            switch(param1.window.name)
            {
               ...
               case const_1045:
                  ...
                  if(var_358 && this.var_169)
                  {
                     ...
                     this.deselect(true);
                     if(param1.window.name == const_1045)
                     {
                        var_508.setMessengerIconNotify(false);
                     }
                  }
                  break;
               case const_1431:
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         var _loc5_:String = const_1085;
         switch(param1.typeCode)
         {
            case FriendNotification.const_1269:
            ...
            case FriendNotification.TYPE_ACHIEVEMENT:
               _loc4_ = new AchievementToken(this.friend,param1,param2,var_2260);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_696;
               break;
            case FriendNotification.const_1247:
               _loc4_ = new QuestToken(this.friend,param1,param2,var_2260);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_696;
               break;
            case FriendNotification.const_409:
               _loc4_ = new MessengerToken(this.friend,param1,param2);
               _loc4_.iconElement.name = const_1045;
