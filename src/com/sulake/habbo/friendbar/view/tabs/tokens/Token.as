package com.sulake.habbo.friendbar.view.tabs.tokens
{
   ...
   public class Token implements IDisposable
   {
      ...
      protected static var var_1437:IHabboWindowManager;
      
      protected static var var_1438:IAssetLibrary;
      
      protected static const ICON:String = "icon";
      
      protected static const const_1153:String = "title";
      
      protected static const const_1154:String = "message";
      
      protected static const const_1429:Rectangle = new Rectangle(0,0,25,25);
      ...
      protected var var_1422:FriendNotification;
      ...
      {
         return this.var_1422.typeCode;
      }
      
      public function get viewOnce() : Boolean
      {
         return this.var_1422.viewOnce;
      }
      ...
      {
         var _loc7_:* = null;
         this._window = var_1437.buildFromXML(var_1438.getAssetByName(param3).content as XML) as IWindowContainer;
         this._window.findChildByName(const_1153).caption = param1;
         this._window.findChildByName(const_1154).caption = !!param2 ? param2 : "";
         _loc7_ = var_1438.getAssetByName(param5) as BitmapDataAsset;
         if(_loc7_)
         {
            IBitmapWrapperWindow(this._window.findChildByName(ICON)).bitmap = _loc7_.content as BitmapData;
         }
         this._icon = var_1437.create("ICON_" + this.typeCode,WindowType.const_365,WindowStyle.const_106,WindowParam.const_31,Token.const_1429) as IRegionWindow;
         this._icon.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = var_1437.create("BITMAP_" + this.typeCode,WindowType.const_456,WindowStyle.const_106,WindowParam.const_188,Token.const_1429) as IBitmapWrapperWindow;
         _loc8_.disposesBitmap = false;
         _loc7_ = var_1438.getAssetByName(param4) as BitmapDataAsset;
         if(_loc7_)
         {
