package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_2087:String = "friend_requests_tab_xml";
      ...
      protected static const const_2085:String = "button_accept_all";
      
      protected static const const_2084:String = "click_area_discard_all";
      
      protected static const const_1434:String = "button_close";
      
      protected static const const_2082:String = "button_accept";
      
      protected static const const_1048:String = "click_area_discard";
      
      protected static const const_1435:String = "text_discard";
      
      private static var var_1527:FriendRequestsTab;
      
      private static const const_75:uint = 4294625561;
      
      private static const const_1084:uint = 4294957414;
      
      private static const const_1626:uint = 4289431312;
      
      private static const const_1627:uint = 4290616362;
      ...
      private var var_1320:IWindowContainer;
      ...
      {
         var _loc2_:FriendRequestsTab = !!var_1527 ? var_1527 : new FriendRequestsTab();
               ...
               if(_loc2_)
               {
                  ...
                  if(!this.var_2044)
                  {
                     ...
                     if(_loc3_)
                     {
                        ...
                        {
                           _loc4_ = this.var_1320.clone() as IWindowContainer;
                           _loc4_.color = _loc8_ % 2 == 0 ? uint(const_1626) : uint(const_1627);
                           ...
                           _loc9_ = var_508.getAvatarFaceBitmap(_loc5_.figure);
                           if(_loc9_)
                           {
      ...
      {
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2087).content as XML) as IWindowContainer;
         ...
         this.var_1320 = _loc7_.removeListItemAt(0) as IWindowContainer;
         return _loc1_;
      }
      ...
      private function releaseRequestsTabWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            _loc3_.bitmap = null;
            ITextWindow(param1.findChildByTag(const_1049)).underline = false;
         }
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1435)).textColor = REGION_REJECT_COLOR_EXPOSED;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1048)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1435)).textColor = const_1555;
            }
         }
      }
