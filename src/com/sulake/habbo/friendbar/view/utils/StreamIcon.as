package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class StreamIcon extends Icon
   {
      ...
      override public function hover(param1:Boolean) : void
      {
         if(param1)
         {
            image = this._assets.getAssetByName(!!var_612 ? "icon_stream_new_hover_png" : "icon_stream_hover_png") as BitmapDataAsset;
         }
         else
         {
            image = this._assets.getAssetByName(!!var_612 ? "icon_stream_new_png" : "icon_stream_png") as BitmapDataAsset;
         }
         super.hover(param1);
      }
