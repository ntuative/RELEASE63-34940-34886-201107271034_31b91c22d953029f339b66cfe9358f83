package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      {
         this.var_94 = param2;
         this.var_1188 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1188.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1188.setValue(1);
         this.var_1187 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1187.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1187.setValue(50);
      }
