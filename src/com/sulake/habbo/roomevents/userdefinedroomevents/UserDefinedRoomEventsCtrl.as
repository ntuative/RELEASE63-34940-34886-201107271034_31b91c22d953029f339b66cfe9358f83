package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_361:int = 3;
      ...
      private var var_1813:TriggerConfs;
      
      private var var_1815:ActionTypes;
      
      private var var_1814:ConditionTypes;
      
      private var var_282:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_806:RoomObjectHightLighter;
      
      private var var_202:UserDefinedRoomEventsHelp;
      
      private var var_1210:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1813 = new TriggerConfs();
         this.var_1815 = new ActionTypes();
         this.var_1814 = new ConditionTypes();
         this.var_282 = new Dictionary();
         super();
         this.var_94 = param1;
         this.var_806 = new RoomObjectHightLighter(param1);
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1210 = new SliderWindowController(this.var_94,IWindowContainer(this.find(this.var_56,"delay_slider_container")),this.var_94.assets,0,20,1);
         this.var_1210.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1210.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_806.hideAll(this.var_282);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_806.showAll(this.var_282);
         if(this.var_37 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_37);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1210.setValue(_loc6_);
         }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_37.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_361)
            {
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1210.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1488) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1488 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_361)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1813);
         this.refreshConfigureElement(this.var_1815);
         this.refreshConfigureElement(this.var_1814);
