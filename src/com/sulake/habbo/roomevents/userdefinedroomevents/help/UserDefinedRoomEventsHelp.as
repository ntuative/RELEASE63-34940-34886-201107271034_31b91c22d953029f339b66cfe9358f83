package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_2036 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1312 = this.var_2036.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1312)
         {
            this.var_1312.procedure = this.onButtonClick;
         }
         this.var_1311 = this.var_2036.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1311)
         {
      ...
      {
         if(this.var_299 >= this.var_74.length - 1)
         {
      ...
      {
         ++this.var_299;
         this.var_299 = Math.min(this.var_299,this.var_74.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_74[this.var_299][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_74[this.var_299][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_74[this.var_299][1]).value;
