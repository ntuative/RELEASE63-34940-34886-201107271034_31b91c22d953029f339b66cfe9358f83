package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1369:Number = 1.0;
      
      private var var_737:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1369,param1);
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_1122);
         }
      ...
      {
         return int(this.var_1792 * (Number(param1 - this._minValue) / (this.var_1369 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1792 * (this.var_1369 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1121)
         {
            if(param1.type == WindowMouseEvent.const_58 || param1.type == WindowMouseEvent.const_284)
            {
               this.var_1121 = false;
            }
         }
         if(!this.var_1121 || param1.type != WindowEvent.const_435)
         {
            return;
         }
         if(this.var_737 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_737) * this.var_737;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_737 != 0)
            {
               _loc3_ = this.var_1122 + this.var_737;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_793 != null)
            {
               ...
               this.var_1792 = _loc1_.width - _loc2_.width;
            }
         }
