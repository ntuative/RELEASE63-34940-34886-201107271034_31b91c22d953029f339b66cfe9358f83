package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1494:Point = new Point(3,3);
      
      private static const const_1618:uint = 7433577;
      
      private static const const_1615:uint = 5723213;
      ...
      private static const const_1620:int = 600;
      
      private static const const_1616:int = 80;
      
      private static const const_1621:int = 74;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1494;
         this._window.addEventListener(WindowEvent.const_618,this.onParentResized);
         ...
         this.var_225.x = _loc13_.width - this.var_225.width - const_482;
         this.var_225.y = const_482;
         this.var_2718 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         var _loc2_:* = this._windowManager.getDesktop(2).height < const_1620;
         if(!param1 && _loc2_ == this.var_1592)
         {
            return;
         }
         this.var_1592 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1621) : int(const_1616);
         var _loc4_:int = !!_loc2_ ? int(const_1619) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1622 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1617;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_225 != null && this.var_2718)
               {
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_893:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_752:
               _loc3_ = true;
         }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_483 ? this.var_1591 : this.var_1590;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_483)
         {
            param1.color = const_1618;
         }
         else
         {
            param1.color = const_1615;
         }
      }
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1592 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1592 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         if(this.var_1590)
         {
            this.var_1590.dispose();
         }
         this.var_1590 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1591)
         {
            this.var_1591.dispose();
         }
         this.var_1591 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1061.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.y = const_482;
            this.var_1061.add(param1,_loc2_);
         }
         return _loc2_;
      }
