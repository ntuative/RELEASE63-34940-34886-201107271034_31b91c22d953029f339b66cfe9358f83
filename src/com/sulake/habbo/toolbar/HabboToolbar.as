package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private static const const_1681:String = "purse";
      
      private static const const_1682:String = "extra_tools";
      ...
      private var var_729:ExtraToolsExtension;
      
      private var _connection:IConnection;
      
      private var _catalog:IHabboCatalog;
      
      private var var_1364:PurseExtension;
      
      private var var_1668:ClubDiscountPromoExtension;
      
      private var _localization:ICoreLocalizationManager;
      
      private var var_12:IHabboInventory;
      
      private var var_728:ExtensionView;
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._connection = this.var_276.getHabboMainConnection(null);
         this.tryInitialize();
      }
      ...
      {
         if(this.var_276 && this._windowManager && this._config && this._localization && this.var_12 && this._catalog)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_728 = new ExtensionView(this._windowManager,this._assetLibrary,this);
            if(this.var_728)
            {
               this.var_1364 = new PurseExtension(this._windowManager,this._assetLibrary,this._config,this._catalog,this.var_12,this._localization);
               this.var_729 = new ExtraToolsExtension(this,this._windowManager,this._assetLibrary,events,this._config);
               if(this._config.getBoolean("club.membership.extend.promotion.enabled",false))
               {
                  this.var_1668 = new ClubDiscountPromoExtension(this,this._windowManager,this._assetLibrary,events,this._config,this._localization,this.var_12,this._catalog,this._connection);
               }
               this.var_728.attachExtension(const_1681,this.var_1364.window,ExtensionFixedSlotsEnum.const_1915);
               this.var_728.attachExtension(const_1682,this.var_729.window,ExtensionFixedSlotsEnum.const_1934);
            }
         }
         if(this._view == null)
         {
