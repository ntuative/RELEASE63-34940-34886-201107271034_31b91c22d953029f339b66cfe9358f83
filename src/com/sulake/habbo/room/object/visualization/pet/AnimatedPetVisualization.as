package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1655:String = "head";
      
      private static const const_720:int = 1;
      
      private static const const_1149:int = 1000;
      
      private static const const_1657:String = "pet_experience_bubble_png";
      
      private static const const_1658:int = 0;
      ...
      public function AnimatedPetVisualization()
      {
         ...
         this.var_1090 = [];
         super();
         while(this.var_141.length < ANIMATION_INDEX_COUNT)
         {
            this.var_141.push(new AnimationStateData());
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_141 != null)
         {
            ...
            {
               _loc2_ = this.var_141[_loc1_] as AnimationStateData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         if(this._animationData.commonAssets != null)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               this.var_407 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_146)
         {
            ...
            this.var_2094 = _loc3_.getNumber(RoomObjectVariableEnum.const_282) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_212);
            if(!isNaN(_loc8_))
            {
               this.var_2079 = _loc8_;
            }
            else
            {
               this.var_2079 = direction;
            }
            this.var_1636 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2358 = _loc3_.getNumber(RoomObjectVariableEnum.const_423);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_957);
            if(_loc9_ != this.var_2078)
            {
               this.var_2078 = _loc9_;
               this.var_2864 = this.var_2078.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_407 != null)
         {
            ...
            if(this.var_1636 > 0)
            {
               _loc2_ = param1 - this.var_1636;
               if(_loc2_ < const_1149)
               {
                  this.var_407.alpha = int(Math.sin(_loc2_ / const_1149 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_407.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_407.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param1 != this.var_302)
         {
            ...
            this.setAnimationForIndex(const_1658,_loc3_);
         }
         if(param2 != this.var_1635)
         {
      ...
      {
         return super.getAdditionalSpriteCount() + const_720;
      }
      ...
      override protected function resetAllAnimationFrames() : void
      {
         var _loc2_:* = null;
         this.var_1640 = false;
         var _loc1_:int = this.var_141.length - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_141[_loc1_];
            if(_loc2_ != null)
            {
      ...
      override protected function getFrameNumber(param1:int, param2:int) : int
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:int = this.var_141.length - 1;
         while(_loc3_ >= 0)
         {
            _loc4_ = this.var_141[_loc3_];
            if(_loc4_ != null)
            {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:int = this.var_141.length - 1;
         while(_loc5_ >= 0)
         {
            _loc6_ = this.var_141[_loc5_];
            if(_loc6_ != null)
            {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2864);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_720)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_720))
            {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2079);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_102,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1655)
            {
