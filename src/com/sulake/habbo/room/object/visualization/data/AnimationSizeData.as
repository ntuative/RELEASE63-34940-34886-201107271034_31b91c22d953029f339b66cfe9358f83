   ...
   public class AnimationSizeData extends SizeData
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_353 != null)
         {
            ...
            {
               _loc2_ = this.var_353.getWithIndex(_loc1_) as AnimationData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineAnimations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            this.var_353.add(_loc6_,_loc9_);
            if(!_loc7_)
            {
               this.var_1639.push(_loc6_);
            }
            _loc4_++;
         }
         return true;
      ...
      {
         if(this.var_353.getValue(param1) != null)
         {
            return true;
         }
         return false;
      ...
      public function getAnimationId(param1:int) : int
      {
         ...
         {
            return this.var_1639[param1 % _loc2_];
         }
         return 0;
      }
      ...
      {
         var _loc3_:AnimationData = this.var_353.getValue(param1) as AnimationData;
         if(_loc3_ != null)
         {
      ...
      {
         var _loc6_:* = null;
         var _loc5_:AnimationData = this.var_353.getValue(param1) as AnimationData;
         if(_loc5_ != null)
         {
      ...
      {
         var _loc8_:* = null;
         var _loc7_:AnimationData = this.var_353.getValue(param1) as AnimationData;
         if(_loc7_ != null)
         {
