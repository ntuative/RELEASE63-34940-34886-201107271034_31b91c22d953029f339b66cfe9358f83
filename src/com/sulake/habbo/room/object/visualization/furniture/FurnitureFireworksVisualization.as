package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureFireworksVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private var var_261:FurnitureParticleSystem;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.readDefinition();
               this.var_261 = this.var_720[param1];
               _loc3_ = true;
            }
      ...
      override protected function setAnimation(param1:int) : void
      {
         if(this.var_261)
         {
            this.var_261.setAnimation(param1);
         }
      ...
      {
         if(this.var_261 && this.var_261.controlsSprite(param3))
         {
            return this.var_261.getSpriteYOffset(param1,param2,param3);
         }
