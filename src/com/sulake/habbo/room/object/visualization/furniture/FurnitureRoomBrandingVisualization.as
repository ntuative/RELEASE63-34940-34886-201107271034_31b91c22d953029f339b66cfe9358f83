package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1565:String = "branded_image";
      
      private static const const_1566:int = 0;
      
      private static const const_1563:int = 1;
      
      private static const const_1564:int = 2;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1721 = _loc4_.getNumber(RoomObjectVariableEnum.const_638);
                  this.var_1722 = _loc4_.getNumber(RoomObjectVariableEnum.const_500);
                  this._paramOffsetZ = _loc4_.getNumber(RoomObjectVariableEnum.const_667);
               }
            }
         }
         if(!this.var_1427)
         {
            this.var_1427 = this.checkIfImageReady();
            if(this.var_1427)
            {
               this.checkAndCreateImageForCurrentState(param1);
               return true;
      ...
      protected function checkIfImageChanged() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               _loc3_ = _loc2_.getString(RoomObjectVariableEnum.const_323);
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(this._imageUrl != null && _loc6_ == const_1565)
         {
