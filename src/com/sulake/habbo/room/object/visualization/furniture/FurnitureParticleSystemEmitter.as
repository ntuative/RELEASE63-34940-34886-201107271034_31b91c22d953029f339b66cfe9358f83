package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1914:String = "cone";
      
      public static const const_1832:String = "plane";
      ...
      private var var_1092:Number = 0.1;
      ...
      public function setup(param1:int, param2:int, param3:Number, param4:Vector3D, param5:Number, param6:Number, param7:String, param8:Number, param9:int, param10:int) : void
      {
         ...
         this.var_301 = param6;
         this.var_2875 = param7;
         this.var_2878 = param9;
         this._energy = param8;
      ...
      public function reset() : void
      {
         ...
         this.var_1093 = 0;
         this.var_1112 = false;
         this.init(0,0,0,this._direction,this.var_2879,this.var_1092,this.var_2878,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1343.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_1112 = true;
         if(this.var_1093 < this.var_1643)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2877)
         {
            switch(this.var_2875)
            {
               case const_1914:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_1092,_loc6_,_loc7_,_loc9_,_loc8_);
            this.var_409.push(_loc4_);
            ++this.var_1093;
            _loc10_++;
         }
      }
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1343.length);
         return this.var_1343[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_1093 < this.var_1643)
         {
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_1093 < this.var_1643)
         {
            ...
            this.y = (2 - this.var_301) * this.y - (1 - this.var_301) * this.lastY + this.var_2089 * this.var_1092 * this.var_1092;
         ...
         for each(_loc2_ in this.var_409)
         {
            ...
            _loc2_.y = (2 - this.var_301) * _loc2_.y - (1 - this.var_301) * _loc2_.lastY + this.var_2089 * this.var_1092 * this.var_1092;
