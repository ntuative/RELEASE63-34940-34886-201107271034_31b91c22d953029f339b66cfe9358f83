package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1470:int = 1;
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            this.var_786[0] = this.getNewPoint(param1,0);
         }
         _loc2_ = getSprite(3);
         if(_loc2_ != null)
         {
            this.var_786[1] = this.getNewPoint(param1,1);
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            if(this.var_786.length == 2)
            {
               return this.var_786[param3 - 2].x;
            }
         }
      ...
      override protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         if(param3 == 2 || param3 == 3)
         {
            if(this.var_786.length == 2)
            {
               return this.var_786[param3 - 2].y;
            }
         }
      ...
      private function getNewPoint(param1:Number, param2:int) : Point
      {
         ...
         var _loc6_:Number = this.var_1190[param2];
         if(param1 == 32)
         {
            _loc7_ = const_1060;
         }
         ...
         if(int(_loc9_) == 0)
         {
            this.var_1190[param2] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1192.push(const_1469);
         this.var_1192.push(const_1470);
         this.var_1190 = new Array();
         this.var_1190.push(this.getRandomAmplitudeFactor());
         this.var_1190.push(this.getRandomAmplitudeFactor());
      }
