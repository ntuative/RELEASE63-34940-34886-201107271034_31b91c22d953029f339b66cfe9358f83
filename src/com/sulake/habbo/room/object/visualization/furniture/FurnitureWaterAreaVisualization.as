package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1631:String = "shore";
      ...
      {
         if(this.var_2750 == param1 && this.var_2751 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1631)
            {
               this.var_2015 = _loc2_;
               this.var_2750 = param1;
               this.var_2751 = direction;
               return this.var_2015;
            }
            _loc2_--;
         }
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_2016 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_478.length)
         {
            if(this.var_478[_loc5_] == true)
            {
               this.var_2016 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_695[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_695[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_569 == 0 || this.var_694 == 0)
         {
            ...
            this.var_569 = _loc2_.getNumber(RoomObjectVariableEnum.const_259);
            this.var_694 = _loc2_.getNumber(RoomObjectVariableEnum.const_375);
         }
         this.var_478 = [];
         this.var_695 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_569 * 2 + this.var_694 * 2)
         {
            this.var_478.push(false);
            this.var_695.push(ShoreMaskCreatorUtility.const_83);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_80,getSize(param3),this.var_478,this.var_695,assetCollection);
      }
