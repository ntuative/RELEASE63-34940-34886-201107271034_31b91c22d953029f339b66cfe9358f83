package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1854:int = 16777215;
      
      public static const const_1941:int = 13421772;
      
      private static const const_1134:int = 16777215;
      
      private static const const_1133:int = 13421772;
      
      private static const const_1136:int = 10066329;
      
      private static const const_1135:int = 10066329;
      
      public static const const_2022:int = 16777215;
      
      public static const const_1806:int = 13421772;
      
      public static const const_2045:int = 10066329;
      ...
      private var var_878:Rectangle = null;
      
      private var var_574:RoomPlaneBitmapMaskParser = null;
      
      private var var_1615:String = null;
      
      private var _floorType:String = null;
      
      private var var_1614:String = null;
      
      private var var_1014:Number = NaN;
      
      private var var_1521:Number = NaN;
      
      private var var_2817:Number = NaN;
      
      private var var_2050:String = null;
      
      private var var_1322:uint = 16777215;
      
      private var var_2818:int = 255;
      ...
      private const const_2398:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_350["null"] = false;
         this.var_350["null"] = true;
         this.var_350["null"] = true;
         this.var_350["null"] = true;
      }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_878 = super.boundingRectangle;
         }
         return new Rectangle(this.var_878.x,this.var_878.y,this.var_878.width,this.var_878.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1014))
         {
            this._planeParser.floorThicknessMultiplier = this.var_1014;
         }
         ...
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_296)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_406)
            {
               ...
               {
                  _loc13_.color = const_1806;
               }
               else
               {
                  _loc13_.color = const_2045;
               }
               if(this._data != null)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_406)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2398 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_403.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_2049)
                  {
                     ...
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2818 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1772)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1463 || _loc3_.y != this.var_2381 || _loc3_.z != this.var_2380 || param1.scale != this.var_2048))
            {
               this.var_1463 = _loc3_.x;
               this.var_2381 = _loc3_.y;
               this.var_2380 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1225);
            if(_loc3_ != this.var_2050)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2050 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_766));
            if(_loc4_ != this.var_1322)
            {
               this.var_1322 = _loc4_;
               this.var_2819 = this.var_1322 & 255;
               this.var_2820 = this.var_1322 >> 8 & 255;
               this.var_2818 = this.var_1322 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1213));
            if(_loc5_ != this.var_2049)
            {
               this.var_2049 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1405);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1359);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_1014 || _loc3_ != this.var_1521))
            {
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1273);
            if(!isNaN(_loc2_) && _loc2_ != this.var_2817)
            {
               this.var_2817 = _loc2_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      {
         if(param1 != this.var_350["null"] || param2 != this.var_350["null"] || param3 != this.var_350["null"])
         {
            this.var_350["null"] = param1;
            this.var_350["null"] = param2;
            this.var_350["null"] = param3;
            this.var_403 = [];
            this.var_705 = [];
         }
      }
         ...
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_350[_loc12_.type]))
                  {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1321;
      }
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_72 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_292)
                              {
