package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_858:PlaneMaskManager = null;
      ...
      private var var_246:BitmapData = null;
      ...
      {
         return this._isVisible && this.var_836;
      }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_836 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_386))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_1019 != null)
            {
               _loc3_ = this.var_1019.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1902,this.var_2568,this.var_2567,this.var_2566,this.var_2569,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1772 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_836)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1487.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1487[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_172.z - originZ,this.var_129.z - originZ,this.var_97.z - originZ,this.var_128.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2382 = relativeDepth;
            this._isVisible = true;
            this.var_1772 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2565);
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_291.length == this.var_1020.length)
         {
         ...
         if(this.var_385.length > this.var_1536.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1018 || this.var_291.length == 0 && this.var_385.length == 0 && !this.var_386 || this.var_858 == null)
         {
            return;
         }
         ...
         if(this.var_386)
         {
            ...
            while(_loc5_ < this.var_291.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_80.width - this.var_80.width * _loc3_.leftSideLoc / this.var_329.length;
                  _loc11_ = this.var_80.height - this.var_80.height * _loc3_.rightSideLoc / this.var_328.length;
                  _loc12_ = _loc3_.type;
                  this.var_858.updateMask(this.var_80,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < this.var_385.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_80.width - this.var_80.width * _loc4_.leftSideLoc / this.var_329.length;
                  _loc11_ = this.var_80.height - this.var_80.height * _loc4_.rightSideLoc / this.var_328.length;
                  _loc13_ = this.var_80.width * _loc4_.leftSideLength / this.var_329.length;
                  ...
                  this.var_1536.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_386 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_246 != null && (this.var_246.width != param1.width || this.var_246.height != param1.height))
         {
            this.var_246.dispose();
            this.var_246 = null;
         }
         if(this.var_246 == null)
         {
            this.var_246 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_246.copyChannel(param1,param1.rect,const_699,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_246.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_246,this.var_246.rect,const_699,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
