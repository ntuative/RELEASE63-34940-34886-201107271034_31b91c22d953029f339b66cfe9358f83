package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_559:WallRasterizer;
      
      private var var_561:FloorRasterizer;
      
      private var var_859:WallAdRasterizer;
      
      private var var_560:LandscapeRasterizer;
      
      private var var_858:PlaneMaskManager;
      ...
      {
         super();
         this.var_559 = new WallRasterizer();
         this.var_561 = new FloorRasterizer();
         this.var_859 = new WallAdRasterizer();
         this.var_560 = new LandscapeRasterizer();
         this.var_858 = new PlaneMaskManager();
      }
      ...
      public function initialize(param1:XML) : Boolean
      {
         ...
         {
            _loc7_ = _loc2_[0];
            this.var_559.initialize(_loc7_);
         }
         var _loc3_:XMLList = param1.floorData;
         if(_loc3_.length() > 0)
         {
            _loc8_ = _loc3_[0];
            this.var_561.initialize(_loc8_);
         }
         var _loc4_:XMLList = param1.wallAdData;
         if(_loc4_.length() > 0)
         {
            _loc9_ = _loc4_[0];
            this.var_859.initialize(_loc9_);
         }
         ...
         {
            _loc11_ = _loc6_[0];
            this.var_858.initialize(_loc11_);
         }
         return true;
      }
      ...
      public function initializeAssetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         this.var_859.initializeAssetCollection(param1);
