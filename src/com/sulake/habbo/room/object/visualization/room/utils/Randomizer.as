package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2275:int = 16777216;
      ...
      private var var_2043:int = 16777216;
      
      private var var_3105:int = 69069;
      ...
      {
         var _loc1_:int = this.var_3105 * this.var_2042 + this.var_3104;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_2043;
         this.var_2042 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_2043 * param2);
      }
   }
}
