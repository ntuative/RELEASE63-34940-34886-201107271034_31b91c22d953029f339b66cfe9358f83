package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureLogic extends MovingObjectLogic
   {
      ...
      private static const const_1058:Number = 0.0625;
      ...
      private var var_1176:RoomObjectUpdateMessage;
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_324,RoomObjectRoomAdEvent.const_326,RoomObjectRoomAdEvent.const_666,RoomObjectStateChangeEvent.const_68,RoomObjectMouseEvent.const_159,RoomObjectRoomAdEvent.const_225,RoomObjectMouseEvent.const_665];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc3_.length() == 1)
         {
            this.var_694 = Number(_loc3_);
         }
         _loc3_ = _loc2_.@z;
         if(_loc3_.length() == 1)
         {
            this.var_1462 = Number(_loc3_);
         }
         this.var_2378 = this.var_569 / 2;
         this.var_2377 = this.var_694 / 2;
         _loc3_ = _loc2_.@centerZ;
         if(_loc3_.length() == 1)
         {
            this.var_1771 = Number(_loc3_);
         }
         else
         {
            this.var_1771 = this.var_1462 / 2;
         }
         ...
         object.getModelController().setNumber(RoomObjectVariableEnum.const_259,this.var_569,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_375,this.var_694,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_651,this.var_1462,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_2046,this.var_2378,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1823,this.var_2377,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_831,this.var_1771,true);
         object.getModelController().setNumberArray(RoomObjectVariableEnum.const_747,this.var_283,true);
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               if(eventDispatcher != null)
               {
                  _loc4_ = object.getId();
                  _loc5_ = object.getType();
                  _loc6_ = new RoomObjectMouseEvent(RoomObjectMouseEvent.const_665,param1.eventId,_loc4_,_loc5_,param1.altKey,param1.ctrlKey,param1.shiftKey,param1.buttonDown);
                  eventDispatcher.dispatchEvent(_loc6_);
               }
         }
      }
      ...
      override public function useObject() : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_666,_loc1_,_loc2_));
               }
            }
            if(eventDispatcher != null)
            {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_832,lastUpdateTime);
         }
      }
      ...
      private function handleItemDataUpdateMessage(param1:RoomObjectItemDataUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1296,param1.itemData);
         }
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1.dir != null && param1.loc != null)
         {
            if(!(param1 is RoomObjectMoveUpdateMessage))
            {
               ...
               if(_loc4_ != null && _loc4_.x != param1.dir.x && this.var_1770 && _loc5_ != null && _loc5_.x == param1.loc.x && _loc5_.y == param1.loc.y && _loc5_.z == param1.loc.z)
               {
                  this.var_374 = 1;
                  this.var_1176 = new RoomObjectUpdateMessage(param1.loc,param1.dir);
                  param1 = null;
               }
            }
            this.var_1770 = true;
      ...
      override protected function getLocationOffset() : IVector3d
      {
         if(this.var_374 > 0)
         {
            this.var_965.x = 0;
            this.var_965.y = 0;
            if(this.var_374 <= const_470 / 2)
            {
               this.var_965.z = const_1058 * this.var_374;
            }
            else if(this.var_374 <= const_470)
            {
               if(this.var_1176)
               {
                  super.processUpdateMessage(this.var_1176);
                  this.var_1176 = null;
               }
               this.var_965.z = const_1058 * (const_470 - this.var_374);
            }
            return this.var_965;
         }
         return null;
