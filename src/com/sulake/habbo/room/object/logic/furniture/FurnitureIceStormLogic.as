   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_1324 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1324 > 0 && param1 >= this.var_1324)
         {
            this.var_1324 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_2053,String(this.var_2053),this.var_2824);
