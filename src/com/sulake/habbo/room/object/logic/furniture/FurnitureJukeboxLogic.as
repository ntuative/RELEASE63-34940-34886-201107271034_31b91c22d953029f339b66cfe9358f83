package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_503,RoomObjectFurnitureActionEvent.const_571,RoomObjectFurnitureActionEvent.const_499,RoomObjectFurnitureActionEvent.const_658,RoomObjectWidgetRequestEvent.const_171];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object.getModelController().getNumber(RoomObjectVariableEnum.const_861) == 1)
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_407,RoomWidgetInfostandExtraParamEnum.const_609);
