package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1921:int = 255;
      
      private var var_1588:uint = 16777215;
      
      private var var_1997:int = 255;
      
      private var var_1291:uint = 16777215;
      
      private var var_1998:int = 255;
      
      private var var_1292:int = 0;
      
      private var var_1999:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_548,RoomObjectMouseEvent.const_159];
         ...
         if(this.var_1589)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1273,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1292)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1921;
            if(_loc2_ - this.var_1292 >= this.var_1999)
            {
               _loc3_ = this.var_1291;
               _loc4_ = this.var_1998;
               this.var_1292 = 0;
            }
            else
            {
               _loc7_ = this.var_1588 >> 16 & 255;
               _loc8_ = this.var_1588 >> 8 & 255;
               _loc9_ = this.var_1588 & 255;
               _loc10_ = this.var_1291 >> 16 & 255;
               _loc11_ = this.var_1291 >> 8 & 255;
               _loc12_ = this.var_1291 & 255;
               _loc13_ = (_loc2_ - this.var_1292) / this.var_1999;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1997 + (this.var_1998 - this.var_1997) * _loc13_;
               this._color = _loc3_;
               this.var_1921 = _loc4_;
            }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_882:
               param2.setString(RoomObjectVariableEnum.const_203,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_867:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_672:
               _loc5_ = "null";
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_1032:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1225,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1330:
               ...
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1386:
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_693:
               param2.setNumber(RoomObjectVariableEnum.const_1405,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1366:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1213,int(param1.bgOnly));
         this.var_1588 = this._color;
         this.var_1997 = this.var_1921;
         this.var_1291 = _loc3_;
         this.var_1998 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_580,0);
            }
            return;
         }
         _loc5_--;
         ...
         if(_loc7_.x >= 0 && _loc7_.x < _loc13_ && _loc7_.y >= 0 && _loc7_.y < _loc14_)
         {
            ...
            _loc4_.setNumber(RoomObjectVariableEnum.const_2009,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_580,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_296 || _loc12_ == RoomPlaneData.const_406)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
