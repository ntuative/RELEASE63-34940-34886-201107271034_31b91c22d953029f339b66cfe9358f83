package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_225,RoomObjectRoomAdEvent.const_324,RoomObjectRoomAdEvent.const_326];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_990,"");
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1192:
                  _loc2_.setString(RoomObjectVariableEnum.const_450,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_990,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_615,Number(true));
                  this.var_1500 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1232);
            }
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               ...
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_990);
