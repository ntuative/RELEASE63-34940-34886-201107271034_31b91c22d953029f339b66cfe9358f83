package com.sulake.habbo.room.object.logic
{
   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_159,RoomObjectMoveEvent.const_434];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2950)
         {
            ...
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1620 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
            ...
            if(param1 is RoomObjectAvatarSleepUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_282,Number(_loc7_.isSleeping));
               return;
            }
         }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_423,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1895,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_957,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_212,_loc3_ + this.var_1125);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_2149;
            _loc2_.setNumber(RoomObjectVariableEnum.const_263,this.var_2149);
            _loc2_.setNumber(RoomObjectVariableEnum.const_162,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_2150;
            _loc2_.setNumber(RoomObjectVariableEnum.const_162,this.var_2150);
         }
         else
         {
            this.var_1125 += 45;
