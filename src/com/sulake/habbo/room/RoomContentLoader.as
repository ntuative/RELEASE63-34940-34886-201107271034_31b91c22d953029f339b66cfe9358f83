package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const name_6:int = 2;
      ...
      private static const const_1100:String = "selection_arrow";
      ...
      private var var_1557:IEventDispatcher = null;
      ...
      private var var_1037:Map = null;
      
      private var _pets:Dictionary;
      
      private var var_1038:Map = null;
      
      private var var_222:PublicRoomData = null;
      
      private var var_1556:Map = null;
      ...
      public function RoomContentLoader(param1:String)
      {
         ...
         this.var_2639 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2640 = param2.getKey("flash.dynamic.download.url","furniture/");
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_555.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_555.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         {
            _loc2_ = this.var_464.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_464.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_850.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_465.add(_loc3_,_loc4_);
               if(this.var_390[_loc7_] == null)
               {
                  this.var_390[_loc7_] = 1;
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_674.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_673.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_673.remove(_loc7_);
               this.var_673.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2642)
         {
            ...
            {
               this.var_1557.dispatchEvent(new Event(const_812));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(this.var_554 != null)
         {
            this.var_554.remove(param2);
            this.var_554.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_554 != null)
         {
            _loc2_ = this.var_554.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_222 != null && (this.var_222.type == param1 || this.var_222.hasWorldType(param1)))
         {
         ...
         {
            return RoomObjectCategoryEnum.const_357;
         }
         return RoomObjectCategoryEnum.const_152;
      }
      ...
      {
         return [const_478,const_701,const_700,const_702,TILE_CURSOR,const_1100];
      }
      ...
      {
         var _loc3_:String = this.var_674.getValue(param1) as String;
      ...
      {
         return this.var_1037.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_1038[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_674.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return this.var_850.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_222 != null && this.var_222.hasWorldType(const_390 + param1))
         {
            return this.var_222.type;
         }
         return param1;
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_249 || param1 == RoomObjectVisualizationEnum.const_56 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_27 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(this.var_673.getValue(param1));
         }
         return 0;
      }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_27:
                     if(this.var_390[_loc4_] == null)
                     {
                        this.var_390[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1556.getValue(param1) != null)
         {
            this.var_222 = this.var_1556.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_800,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2639.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1916);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_625,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_1038.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1556.add(param1,_loc4_);
         this.var_222 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_851.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_851.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_555.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_851.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_555.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_555.add(_loc5_,_loc4_);
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_540.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            this.var_464.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_464.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_464[_loc2_] != null)
         {
            _loc3_ = this.var_464.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_222.getWorldHeightScale(const_390 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_222 != null)
         {
            return this.var_222.getWorldScale(const_390 + param1);
         }
         return 32;
      }
