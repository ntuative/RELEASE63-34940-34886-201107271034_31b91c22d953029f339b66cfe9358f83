package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_697:String = "temporary_room";
      ...
      private var var_834:IRoomObjectFactory = null;
      
      private var var_540:IRoomObjectVisualizationFactory = null;
      ...
      private var var_460:RoomMessageHandler = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_460 = new RoomMessageHandler(this);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_834.release(new IIDRoomObjectFactory());
            this.var_834 = null;
         }
         if(this.var_540 != null)
         {
            this.var_540.release(new IIDRoomObjectVisualizationFactory());
            this.var_540 = null;
         }
      ...
      public function requestMouseCursor(param1:String, param2:int, param3:String) : void
      {
         ...
         switch(param1)
         {
            case RoomObjectFurnitureActionEvent.const_276:
      ...
      private function addBtnMouseCursorOwner(param1:int, param2:int) : void
      {
         ...
         var _loc3_:IRoomSession = this.var_15.getSession(this.var_86,this.var_85);
      ...
      private function createRoomFurniture() : void
      {
         ...
         do
         {
            for each(_loc4_ in _loc8_)
            {
               ...
               while(!this.var_1017 && (_loc6_ = _loc4_.getWallItemData()) != null)
               {
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         while(_loc3_ < this.var_290.length)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               if(_loc11_ != null)
               {
                  if(_loc7_ != this.var_86 || _loc8_ != this.var_85 || !this.var_1016)
                  {
         ...
         var _loc4_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_86,this.var_85,1);
         if(_loc4_ != null)
         {
            if(this.var_1016)
            {
               _loc4_.screenOffsetX += this.var_1531;
               _loc4_.screenOffsetY += this.var_1529;
               this.var_1531 = 0;
               this.var_1529 = 0;
            }
         }
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               if(_loc9_.screenWd != _loc13_ || _loc9_.screenHt != _loc14_ || _loc9_.scale != _loc8_.scale || _loc9_.geometryUpdateId != _loc8_.updateId || !Vector3d.isEqual(param4,_loc9_.targetObjectLoc) || _loc9_.isMoving)
               {
                  ...
                  _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_835) - 0.5;
                  _loc18_ = _loc10_.getNumber(RoomVariableEnum.const_814) - 0.5;
                  _loc19_ = _loc10_.getNumber(RoomVariableEnum.const_827) + 0.5;
      ...
      private function onObjectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_834 = param2 as IRoomObjectFactory;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_540 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_14 != null)
         {
            this.var_14.visualizationFactory = this.var_540;
         }
         this.initializeRoomManager();
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            this._roomManager.addObjectUpdateCategory(RoomObjectCategoryEnum.const_357);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_460 != null)
            {
               this.var_460.connection = param1;
            }
         }
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2556 = this.var_157.getKey("room.dragging.always_center","0") == "1";
         this.initializeRoomManager();
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_343.events.addEventListener(AdEvent.const_622,this.showRoomAd);
         this.var_343.events.addEventListener(AdEvent.const_780,this.onRoomAdImageLoaded);
         this.var_343.events.addEventListener(AdEvent.const_1229,this.onRoomAdImageLoaded);
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_70,this.onRoomSessionEvent);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_70:
               if(this.var_460)
               {
                  this.var_460.setCurrentRoom(param1.session.roomId,param1.session.roomCategory);
               }
               break;
            case RoomSessionEvent.const_86:
               if(this.var_460)
               {
                  this.var_460.resetCurrentRoom();
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_834 != null)
         {
            this.var_834.addObjectEventListener(this.roomObjectEventHandler);
         }
      }
      
      private function initializeRoomManager() : void
      {
         if(this.var_834 == null || this.var_540 == null || this._roomManager == null || this._roomRendererFactory == null || this._communication == null || this.var_157 == null || !this.var_2557)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_542 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_844,0,0));
            _loc2_ = 0;
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1291,_loc5_);
            if(_loc5_ == 0)
            {
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1291);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1182,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_998,1,true);
            _loc12_ = parseInt(this.var_157.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1232,_loc12_,true);
            if(this.var_14 != null)
            {
         ...
         else
         {
            ...
            _loc7_.setNumber(RoomVariableEnum.const_998,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_1039,_loc10_,true);
         if(param2 != null)
         {
            _loc13_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_835,_loc15_);
               _loc7_.setNumber(RoomVariableEnum.const_827,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_814,_loc17_);
         ...
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         {
            ...
            if(param3 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_882,param3);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_203,param3);
            }
            if(param4 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_867,param4);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               ...
               if(param2.doors.door.length() > 0)
               {
                  ...
                  while(_loc23_ < _loc20_.length())
                  {
                     ...
                     if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                     {
                        ...
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_672,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_292);
                        _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                        if(_loc28_ == 90 || _loc28_ == 180)
                        {
                           if(_loc28_ == 90)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_922,_loc25_ - 0.5,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_959,_loc26_,true);
                           }
                           if(_loc28_ == 180)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_922,_loc25_,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_959,_loc26_ - 0.5,true);
                           }
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1357,_loc27_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1275,_loc28_,true);
                        }
                     }
                     _loc23_++;
                  }
         ...
         _loc7_.createRoomObject(const_1088,const_1557,RoomObjectCategoryEnum.const_357);
         if(this.var_157.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_1086,const_1556,RoomObjectCategoryEnum.const_357);
         }
         return _loc7_;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_389,RoomObjectCategoryEnum.const_82);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null, param6:Boolean = false) : Boolean
      {
         ...
         if(param3 != null)
         {
            ...
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_882,param3);
         ...
         if(param4 != null)
         {
            ...
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_867,param4);
            _loc7_.getEventHandler().processUpdateMessage(_loc9_);
         }
         if(param5 != null)
         {
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1386,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1330,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function updateObjectRoomPlaneThicknesses(param1:int, param2:int, param3:Number, param4:Number) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlanePropertyUpdateMessage(RoomObjectRoomPlanePropertyUpdateMessage.const_1366,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1323;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_1039);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_922);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_959);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1357);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1275);
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var _loc10_:* = null;
         var _loc11_:* = null;
         var _loc8_:int = param2 - this.var_1530;
         var _loc9_:int = param3 - this.var_1532;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1016 = true;
               this.var_833 = false;
               this.var_2554 = this.var_1530;
               this.var_2555 = this.var_1532;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1016)
            {
               if(!this.var_833)
               {
                  _loc8_ = param2 - this.var_2554;
                  _loc9_ = param3 - this.var_2555;
                  if(_loc8_ <= -const_476 || _loc8_ >= const_476 || _loc9_ <= -const_476 || _loc9_ >= const_476)
                  {
                     this.var_833 = true;
                  }
                  _loc8_ = 0;
               ...
               {
                  this.var_1531 += _loc8_;
                  this.var_1529 += _loc9_;
                  this.var_833 = true;
               }
            }
         }
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_634,this.var_86,this.var_85,-1,RoomObjectCategoryEnum.const_152));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_73 != null)
                  {
                     ...
                     this.var_73.handleRoomObjectEvent(_loc14_,this.var_86,this.var_85);
                  }
               }
            }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_86,this.var_85,this.var_1528);
         if(_loc6_ != null)
         {
            ...
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1530 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1532 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_86,this.var_85,this.var_1528);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_86,this.var_85,this.var_1528);
         if(_loc1_ != null)
         {
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_73 != null)
         {
            return this.var_73.modifyRoomObject(this.var_86,this.var_85,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectDataWithMap(param1:int, param2:int, param3:String, param4:Map) : Boolean
      {
         if(this.var_73 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               return this.var_73.modifyRoomObjectData(this.var_86,this.var_85,param1,param2,param3,param4);
            }
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_73 != null)
         {
            ...
            {
               return this.var_73.modifyWallItemData(this.var_86,this.var_85,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_73 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return this.var_73.deleteWallItem(this.var_86,this.var_85,param1);
            }
         }
         return false;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_998) != 0)
         {
            return false;
         }
         if(this.var_73 != null)
         {
            return this.var_73.initializeRoomObjectInsert(this.var_86,this.var_85,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_73 != null)
         {
            this.var_73.cancelRoomObjectInsert(this.var_86,this.var_85);
         }
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1086,RoomObjectCategoryEnum.const_357);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1088,RoomObjectCategoryEnum.const_357);
      }
      ...
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         if(_loc9_ != null && _loc9_.getModelController() != null && _loc5_)
         {
            ...
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_861,1,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1183,param4.expiryTime);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1334,getTimer());
            if(param4.knownAsUsable)
            {
               _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1027,1);
            }
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_194,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      public function changeObjectState(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         {
            _loc6_ = Number(_loc5_.getModelController().getNumber(RoomObjectVariableEnum.const_885));
            if(isNaN(_loc6_))
            {
               _loc6_ = 1;
            }
            ...
            _loc5_.getModelController().setNumber(RoomObjectVariableEnum.const_885,_loc6_);
         }
      }
      ...
      private function addObjectWallItemFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         if(_loc8_ != null && _loc8_.getModelController() != null)
         {
            ...
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1323,1,true);
            if(param4.knownAsUsable)
            {
               _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1027,1);
            }
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_194,param1,param2,param3,RoomObjectCategoryEnum.const_26));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1206) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1298);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_672,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_1032,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_194,param1,param2,param3,RoomObjectCategoryEnum.const_29));
         }
         return true;
      }
      ...
      public function updateObjectUserAction(param1:int, param2:int, param3:int, param4:String, param5:int, param6:String = null) : Boolean
      {
         ...
         switch(param4)
         {
            case RoomObjectVariableEnum.const_199:
               ...
               break;
            case RoomObjectVariableEnum.const_260:
            ...
            case RoomObjectVariableEnum.const_584:
               ...
               break;
            case RoomObjectVariableEnum.const_423:
               _loc8_ = new RoomObjectAvatarExperienceUpdateMessage(param5);
               break;
            case RoomObjectVariableEnum.const_454:
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            if(_loc4_.disposeObject(param2,param3))
            {
               if(events != null)
               {
                  events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_462,this.var_86,this.var_85,param2,param3));
               }
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_73 != null)
         {
            this.var_73.handleRoomObjectEvent(param1,this.var_86,this.var_85);
         }
      }
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               if(_loc7_ != null)
               {
                  _loc13_ = null;
                  _loc14_ = "undefined_1";
                  _loc13_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_672,_loc14_,_loc7_,new Vector3d(2.5,0.5,2));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         var _loc11_:IRoomInstance = this._roomManager.getRoom(const_697);
         if(_loc11_ == null)
         {
            _loc11_ = this._roomManager.createRoom(const_697,null);
            if(_loc11_ == null)
            {
               return _loc10_;
            }
         ...
         switch(_loc13_)
         {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               {
                  _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_957,int(param2));
               }
               break;
         ...
         {
            this.var_1254.add(String(_loc12_),param5);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1364,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_86,this.var_85,const_389,RoomObjectCategoryEnum.const_82,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this._roomManager.getRoom(const_697);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1364);
               ...
               _loc13_ = this.var_1254.remove(String(_loc10_)) as IGetImageListener;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc6_ != null && _loc6_.getModel() != null && _loc6_.getEventHandler() != null)
         {
            ...
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_894,_loc4_,_loc5_,param2,param3));
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_14 != null)
         {
            ...
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1209,param1.adWarningL,true);
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1216,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1192,RoomObjectVariableEnum.const_450,param1.clickUrl);
      ...
      private function onRoomAdImageLoaded(param1:AdEvent) : void
      {
         ...
         switch(param1.type)
         {
            case AdEvent.const_780:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1227,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
               break;
            case AdEvent.const_1229:
