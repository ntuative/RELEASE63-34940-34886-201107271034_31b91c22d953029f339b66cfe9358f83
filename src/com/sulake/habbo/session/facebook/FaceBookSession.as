package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1142:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1644:String = "sendAccessTokenToServer";
      
      private static const const_1643:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1644,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1643,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1142);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1142);
         }
      }
