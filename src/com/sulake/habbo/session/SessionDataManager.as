package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1801:UserTagManager;
      
      private var var_1199:BadgeImageManager;
      
      private var var_1200:HabboGroupInfoManager;
      
      private var var_980:IgnoredUsersManager;
      ...
      private var var_1202:FaceBookSession;
      
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super(param1,param2,param3);
         this.var_3088 = [];
         this.var_1801 = new UserTagManager(events);
         this.var_1200 = new HabboGroupInfoManager(this,events);
         this.var_980 = new IgnoredUsersManager(this);
         this.var_1202 = new FaceBookSession();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_332)
         {
            this.var_332.removeEventListener(FurnitureDataParser.const_138,this.onFurnitureReady);
            this.var_332.dispose();
            this.var_332 = null;
         }
         if(this.var_641)
         {
            this.var_641.removeEventListener(ProductDataParser.const_138,this.method_3);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         this.var_1199 = new BadgeImageManager(context.root.assets,events,this.var_144,this._localization);
      }
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_332)
         {
            ...
            this.var_332 = new FurnitureDataParser(this.var_529,this._wallItems,this.var_530,this._localization);
            this.var_332.addEventListener(FurnitureDataParser.const_138,this.onFurnitureReady);
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_1799 = _loc2_.clubLevel;
         this.var_1800 = _loc2_.securityLevel;
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2686 = _loc3_.respectTotal;
         ...
         this.var_1903 = _loc3_.realName;
         this.var_980.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            ...
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this.var_671,this.var_1034));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2416 = _loc2_.isOpen;
         this.var_2415 = _loc2_.onShutDown;
      }
      ...
      {
         return this.var_1800 >= SecurityLevelEnum.const_1270;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_1801.getTags(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         var _loc2_:HabboGroupDetails = this.var_1200.getGroupDetails(param1);
         if(_loc2_ != null)
         {
      ...
      {
         return this.var_1200.getGroupDetails(param1);
      }
      
      public function getGroupBadgeId(param1:int) : String
      {
         return this.var_1200.getBadgeId(param1);
      }
      
      public function getGroupBadgeImage(param1:String) : BitmapData
      {
         return this.var_1199.getBadgeImage(param1,BadgeImageManager.const_1287);
      }
      ...
      {
         return this.var_980.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_980.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_980.unignoreUser(param1);
      }
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(this.var_641 == null)
         {
            ...
            this.var_641 = new ProductDataParser(_loc2_,this.var_1207);
            this.var_641.addEventListener(ProductDataParser.const_138,this.method_3);
         }
         return false;
      }
