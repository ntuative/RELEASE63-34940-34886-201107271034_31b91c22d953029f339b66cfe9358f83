package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2840:IWindowContainer;
      ...
      private const const_2102:Point = new Point(120,150);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this.var_27.inventoryViewOpened(this.var_884);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         {
            if(param3 && this.var_405 != null && this.var_405 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_405 || !this.var_27.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_884);
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         {
            this.resetUnseenCounters(this.var_405);
         }
         ...
         _loc2_.container.removeChild(this.var_2062);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_405 == InventoryCategory.const_137)
            {
               this.toggleCategoryView(InventoryCategory.const_137);
            }
            else if(this.var_405 == InventoryCategory.const_74)
            {
               this.toggleCategoryView(InventoryCategory.const_74);
            }
            else if(this.var_27 != null)
            {
               this.var_27.toggleInventoryPage(InventoryCategory.const_74);
            }
         }
      }
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_2063)
         {
            this.var_2063 = this.createCounter("badges");
         }
         var _loc1_:int = this.var_27.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_2063,_loc1_);
