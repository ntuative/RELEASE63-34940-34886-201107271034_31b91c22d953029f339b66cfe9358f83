package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1718:int = 100;
      
      private static const const_1719:int = 1000;
      ...
      private var var_1689:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_494 = [];
         this.var_495 = [];
         this.var_744 = new Timer(const_1718,1);
         this.var_744.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2990 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_744.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_744.stop();
               this.var_744 = null;
            }
            if(this.var_233 != null)
            {
               this.var_233.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_233.stop();
               this.var_233 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_38)
            {
               ...
               {
                  this.var_1689 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1689;
            }
            else
            {
         ...
         this.var_27.setInventoryCategoryInit(InventoryCategory.const_74);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_911 == null)
         {
            this.var_911 = this._windowManager.buildFromXML(this.var_2990) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_911.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_911.clone() as IWindowContainer;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_233 = new Timer(param1,1);
            this.var_233.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_233.start();
         }
         else
         {
      ...
      {
         if(param1 == InventoryCategory.const_74 && this.var_27.isVisible)
         {
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_743.add(const_38,new Array());
         this.var_743.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      {
         return getTimer() < this.var_2991 + const_1719;
      }
      ...
      {
         return this.var_27.getSubCategoryViewId() == InventorySubCategory.const_341;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_384 || _loc3_.category == FurniCategory.const_343 || _loc3_.category == FurniCategory.const_347)
         {
            if(param1)
            {
               return false;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_341:
               this.cancelFurniInMover();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_743.getValue(param1) as Array;
         if(_loc3_ != null)
         {
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         switch(param1)
         {
            ...
            case const_38:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_412));
                  this.var_494 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
