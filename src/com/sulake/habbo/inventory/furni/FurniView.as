package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1094:int = 42;
      
      private static const const_1095:int = 120;
      ...
      private var var_838:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_220.add(FurniModelCategory.const_38,new FurniGridView(this.var_78,FurniModelCategory.const_38,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_220.add(FurniModelCategory.const_45,new FurniGridView(this.var_78,FurniModelCategory.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_220.getValue(this.var_463);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_78.getCategoryContent(this.var_463);
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_220.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_220.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function moveItemTo(param1:GroupItem, param2:int) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_220.getValue(param1.mainCategory);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_78.getUnseenItemCount(UnseenItemCategoryEnum.const_412) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_78.getUnseenItemCount(UnseenItemCategoryEnum.const_397) > 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_78.getGroupItemInIndex(_loc3_,this.var_463);
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_838 && this.var_838.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1345)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > const_1095)
         {
            _loc3_ = const_1095;
         }
         else if(_loc3_ < const_1094)
         {
            _loc3_ = const_1094;
         }
         else
