package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_1078:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_1078 = this._view.findChildByName("active_items") as IItemGridWindow;
         this.var_1078.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onActiveBadgeClick);
      }
      ...
      private function updateListViews() : void
      {
         ...
         this.var_1078.removeGridItems();
         var _loc2_:Array = this.var_78.getBadges(BadgesModel.const_617);
         var _loc4_:int = 0;
         ...
         var _loc5_:Array = this.var_78.getBadges(BadgesModel.const_340);
         _loc4_ = 0;
         while(_loc4_ < _loc5_.length)
         {
            _loc3_ = _loc5_[_loc4_] as Badge;
            this.var_1078.addGridItem(_loc3_.window);
      ...
      public function updateActionView() : void
      {
         ...
         else
         {
            ...
            _loc3_ = this.var_78.getBadges(BadgesModel.const_340);
      ...
      {
         var _loc2_:int = this.var_1078.getGridItemIndex(param1.window);
