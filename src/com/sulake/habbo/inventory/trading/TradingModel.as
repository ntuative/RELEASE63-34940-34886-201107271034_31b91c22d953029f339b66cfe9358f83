package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_2033:uint = 9;
      ...
      public static const const_381:uint = 3;
      
      public static const const_604:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_61.updateItemList(this.var_874);
         this.var_61.updateItemList(this.var_1612);
      ...
      public function close() : void
      {
         if(this.var_831)
         {
            if(this._state != const_206 && this._state != const_300)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_875 + " OTHER: " + this.var_1313);
         ...
         {
            case const_206:
               if(param1 == const_220 || param1 == const_300)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_61.alertPopup(TradingView.const_1228);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_874)
            {
               this.var_875 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1313 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_61.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_874)
            {
               this.var_61.alertPopup(TradingView.const_1312);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_300.length < const_2033)
         {
