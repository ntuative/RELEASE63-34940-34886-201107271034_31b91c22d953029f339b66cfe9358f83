package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            this.var_15.events.removeEventListener(RoomSessionEvent.const_70,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionEvent.const_86,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_562,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_66.getValue(InventoryCategory.const_74));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_66.getValue(InventorySubCategory.const_341));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_66.getValue(InventoryCategory.const_161));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_66.getValue(InventoryCategory.const_228));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_66.getValue(InventorySubCategory.const_1388));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_66.getValue(InventoryCategory.const_137));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_66.getValue(InventoryCategory.const_439) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_70,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionEvent.const_86,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_562,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_86:
               ...
               break;
            case RoomSessionPropertyUpdateEvent.const_562:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      private function initInventory() : void
      {
         ...
         this.var_66.add(InventoryCategory.const_439,_loc1_);
         ...
         this.var_66.add(InventoryCategory.const_161,_loc4_);
         ...
         this.var_66.add(InventorySubCategory.const_341,_loc5_);
         ...
         this.var_66.add(InventorySubCategory.const_1388,_loc6_);
         ...
         this.var_66.add(InventoryCategory.const_137,_loc7_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_1107.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_1107.indexOf(param1);
            if(_loc3_ >= 0)
            {
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_255));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2904)
         {
            this.var_2904 = _loc1_;
