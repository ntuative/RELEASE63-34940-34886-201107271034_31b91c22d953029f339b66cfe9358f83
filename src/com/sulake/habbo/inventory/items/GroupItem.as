package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_757:BitmapData;
      
      protected var var_2595:int;
      ...
      private const const_2129:Number = 1;
      
      private const const_2128:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1633));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2268);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_972)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2128;
               _loc1_.blend = this.const_2128;
            }
            else
            {
               this._window.blend = this.const_2129;
               _loc1_.blend = this.const_2129;
            }
         }
         this.var_1481.color = !!this.var_1652 ? uint(const_1540) : uint(const_1541);
         this.var_2524.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2285 && this.getRecyclableCount() > 0)
            {
