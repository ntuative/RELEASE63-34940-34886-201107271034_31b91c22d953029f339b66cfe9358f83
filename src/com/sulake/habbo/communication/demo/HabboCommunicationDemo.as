package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2671:PseudoRandom;
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_677 = param1;
            this.var_64.initConnection(HabboConnectionType.const_248);
         }
      }
      ...
      {
         if(this.var_64 && this.var_157 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_677 = this.var_157.getKey("sso.ticket",null);
         this.var_1971 = this.var_157.getKey("flash.client.url","");
         this.var_2670 = this.var_157.getKey("external.variables.txt","");
         if(this.var_251 == null)
         {
            this.var_251 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_64.mode = HabboConnectionType.const_101;
            if(this.var_677)
            {
               this.var_64.initConnection(HabboConnectionType.const_248);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_849,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1978);
            }
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2671 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_64.mode)
         {
            case HabboConnectionType.const_101:
               _loc6_ = "";
               ...
               this.var_1570 = _loc4_;
               this.var_251.loadBannerImage(_loc7_ + "?token=" + this.var_1570,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1331:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_2053:
               this.var_1041 = this.generateRandomHexString(30);
               this.var_558 = new DiffieHellman(new BigInteger(this.var_157.getKey("connection.development.prime"),16),new BigInteger(this.var_157.getKey("connection.development.generator"),16));
               this.var_558.init(this.var_1041);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2671);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1971,this.var_2670));
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_677 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_677);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2669)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1570);
