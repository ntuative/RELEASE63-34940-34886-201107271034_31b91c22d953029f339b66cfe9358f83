package com.sulake.habbo.communication.encryption
{
   ...
   public class RC4_R27 extends RC4 implements IEncryption
   {
      ...
      private static const const_1593:int = 52;
      ...
      private static const const_1112:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
       
      
      private var var_1966:IEncryption;
      ...
      override public function encipher(param1:ByteArray, param2:Boolean = false) : ByteArray
      {
         ...
         if(this.var_1966 != null)
         {
            ...
            _loc6_ = this.var_2658.nextInt() % 5;
            ...
            _loc5_ = this.var_1966.encipher(_loc7_,true);
