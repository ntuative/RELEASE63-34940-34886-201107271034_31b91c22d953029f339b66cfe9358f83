package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1575:String = "inventory";
      
      private static const const_1574:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1569:String = "friendlist";
      
      private static const const_1570:String = "pet_inventory";
      
      private static const const_1571:String = "go_to_room";
      ...
      private var var_1926:IHabboToolbar;
      ...
      private var var_547:HabboNotificationViewManager;
      
      private var var_248:HabboAlertDialogManager;
      
      private var var_840:ParkBusDialogManager;
      
      private var var_2590:Boolean;
      
      private var var_1029:ClubGiftNotification;
      
      private var var_1028:ClubEndingNotification;
      
      private var var_1030:ClubPromoNotification;
      
      private var var_3095:Dictionary;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1925 = false;
         this.var_3095 = new Dictionary();
         var _loc4_:IAsset = this._assetLibrary.getAssetByName("habbo_notifications_config_xml");
         var _loc5_:XmlAsset = XmlAsset(_loc4_);
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1027);
         }
         var _loc6_:Map = this.var_1027["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1027["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
      ...
      {
         var _loc1_:Array = this.var_1262.splice(0,1);
      ...
      {
         this.var_1926 = param2 as IHabboToolbar;
      }
      ...
      {
         this.var_547 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this._config,this.var_1926,this.var_1027["styles"],this.var_1027["view"]);
         ...
         registerUpdateReceiver(this.var_547,1);
         registerUpdateReceiver(this,2);
         this.var_415.events.addEventListener(BadgeImageReadyEvent.const_230,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_415.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1342,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1342,null);
            }
         }
      }
      ...
      {
         this.addItem(param1,NotificationType.const_904,null);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_2037,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1376)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1891,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1030 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      private function checkClubEndingNotification(param1:ScrSendUserInfoMessageParser) : void
      {
         ...
         if(_loc2_ > 0 && param1.daysToPeriodEnd > 0 && param1.daysToPeriodEnd <= _loc2_ && param1.periodsSubscribedAhead == 0)
         {
            ...
            this.var_1028 = new ClubEndingNotification(param1.daysToPeriodEnd,param1.isVIP,assets,this._windowManager,this._catalog,this._localization);
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_547.isSpaceAvailable() && this.var_1262.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_547.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      private function onBadgeImage(param1:BadgeImageReadyEvent) : void
      {
         ...
         {
            this.var_547.replaceIcon(param1);
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_840 == null)
         {
            this.var_840 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_840 != null)
         {
            this.var_840.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1265,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1265,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_1127.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_62);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2590)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_904,null);
            this.var_2590 = true;
      ...
      {
         if(param2.type == WindowEvent.const_147 || param2.type == WindowEvent.const_504)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1029 && this.var_1029.visible)
         {
            return;
         }
         this.var_1029 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog,this.var_1926);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_904,_loc6_);
      }
   }
}
