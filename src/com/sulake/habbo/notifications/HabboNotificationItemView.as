package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      private static const name_5:int = 0;
      
      private static const const_524:int = 1;
      ...
      private var var_1234:uint;
      
      private var var_1235:uint;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1865 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1865 = 15;
         }
         this.var_1864 = this._window.height;
         this.var_1505 = 4;
         this._blend = 0;
         this._state = name_5;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_524:
               ...
               _loc2_ = Number(this.var_1234) / Number(this.var_1001["time_fade_in"]);
               if(this.var_1234 > int(this.var_1001["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1078:
               ...
               if(this.var_1504 > int(this.var_1001["time_display"]) && !this.var_1863)
               {
                  this.startFadeOut();
               }
               break;
            case const_1079:
               ...
               _loc3_ = 1 - Number(this.var_1235) / Number(this.var_1001["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1235 > int(this.var_1001["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1865;
         if(this._window.height < this.var_1864)
         {
            this._window.height = this.var_1864;
         }
      }
