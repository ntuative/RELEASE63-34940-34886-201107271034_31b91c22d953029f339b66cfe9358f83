package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1767:String = "sample_44khz";
      
      public static const const_1805:String = "sample_22khz";
      
      public static const const_2060:String = "sample_11khz";
      
      public static const const_2008:String = "sample_16bit";
      
      public static const const_1820:String = "sample_8bit";
      
      public static const SAMPLE_VALUE_MULTIPLIER:Number = 0.000030517578125;
      
      private static const const_1098:int = 32;
      ...
      private var var_135:Vector.<int> = null;
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_179 * this.var_87;
         var _loc7_:int = param1.length / 8;
         _loc7_ = int(_loc7_ / _loc6_) * _loc6_;
         this.var_135 = new Vector.<int>(_loc7_ / _loc6_,true);
         ...
         while(_loc11_ < _loc10_)
         {
            ...
            if(_loc11_ >= _loc10_ - 1 - const_1098)
            {
               _loc12_ *= (_loc10_ - _loc11_ - 1) / Number(const_1098);
            }
            ...
            {
               this.var_135[int(_loc11_ / this.var_179)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_135.length * this.var_179 * this.var_87;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:* = 0;
         if(param1 == null || this.var_135 == null)
         {
            return param4;
         }
         var _loc5_:int = this.var_179 * this.var_87;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
         ...
         var _loc7_:int = 0;
         if(_loc6_ > this.var_135.length - param4)
         {
            _loc7_ = (_loc6_ - (this.var_135.length - param4)) * _loc5_;
            _loc6_ = this.var_135.length - param4;
