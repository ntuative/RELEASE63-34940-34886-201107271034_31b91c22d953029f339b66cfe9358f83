package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSequencer implements IHabboSound, IDisposable
   {
      ...
      private static const const_1062:uint = 88000;
      
      private static const const_685:uint = 88000;
      
      private static const const_200:Vector.<int> = new Vector.<int>(const_118,true);
      ...
      private var var_977:Sound;
      
      private var var_446:SoundChannel;
      
      private var var_447:TraxData;
      ...
      {
         return this.var_444 / const_119;
      }
      
      public function set fadeOutSeconds(param1:Number) : void
      {
         this.var_444 = int(param1 * const_119);
      }
      
      public function get fadeInSeconds() : Number
      {
         return this.var_788 / const_119;
      }
      
      public function set fadeInSeconds(param1:Number) : void
      {
         this.var_788 = int(param1 * const_119);
      }
      ...
      public function set volume(param1:Number) : void
      {
         ...
         {
            this.var_446.soundTransform = new SoundTransform(this.var_1010);
         }
      }
      
      public function get length() : Number
      {
         return this.var_280 / const_119;
      }
      ...
      public function prepare() : Boolean
      {
         ...
         if(!this.var_1477)
         {
            ...
            {
               this.var_1476 = false;
               if(this.var_447.hasMetaData)
               {
                  this.var_1476 = this.var_447.metaCutMode;
               }
               if(this.var_1476)
               {
      ...
      private function prepareLegacySequence() : Boolean
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_447.channels.length)
         {
            _loc3_ = new Map();
            _loc4_ = this.var_447.channels[_loc2_] as TraxChannel;
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            while(_loc7_ < _loc4_.itemCount)
            {
               ...
               _loc9_.setUsageFromSong(this.var_1473,_loc1_);
               if(_loc9_ == null)
               {
      ...
      private function prepareSequence() : Boolean
      {
         ...
         while(_loc2_ < this.var_447.channels.length)
         {
            ...
            while(_loc8_ < _loc4_.itemCount)
            {
               ...
               _loc10_.setUsageFromSong(this.var_1473,_loc1_);
               if(_loc10_ == null)
               {
      ...
      public function play(param1:Number = 0.0) : Boolean
      {
         ...
         this.var_527 = 0;
         this.var_633 = false;
         this.var_977.addEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this.var_1475 = param1 * const_119;
         this.var_1194 = 0;
         this.var_1785 = 0;
         this.var_446 = this.var_977.play();
         this.volume = this.var_1010;
         return true;
      }
      ...
      {
         if(this.var_444 > 0 && !this.var_633)
         {
      ...
      private function stopImmediately() : void
      {
         ...
         {
            this.var_977.removeEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         }
      }
      ...
      private function stopWithFadeout() : void
      {
         if(this.var_634 == null)
         {
            this.var_789 = true;
            this.var_527 = 0;
            this.var_634 = new Timer(this.var_1478 + this.var_444 / (const_119 / 1000),1);
            this.var_634.start();
      ...
      private function getSampleBars(param1:uint) : int
      {
         if(this.var_1476)
         {
            return Math.round(param1 / const_1062);
         }
         return Math.ceil(param1 / const_1062);
      }
      ...
      private function getChannelSequenceOffsets() : Array
      {
         ...
         if(this.var_331 != null)
         {
            _loc2_ = this.var_331.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_331[_loc3_];
               _loc5_ = 0;
      ...
      private function mixChannelsIntoBuffer() : void
      {
         ...
         var _loc2_:int = this.var_331.length;
         var _loc3_:* = null;
         var _loc4_:int = _loc2_ - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_331[_loc4_];
            ...
            _loc8_ = const_118;
            if(this.var_280 - this.var_173 < _loc8_)
            {
               _loc8_ = this.var_280 - this.var_173;
            }
            _loc9_ = 0;
            while(_loc9_ < _loc8_)
            {
      ...
      {
         var _loc1_:int = this.var_280 < this.var_1475 ? int(this.var_280) : (this.var_1475 > 0 ? int(this.var_1475) : int(this.var_280));
         if(this.var_173 > _loc1_ + this.var_1478 * (const_119 / 1000) && !this.var_633)
         {
            this.var_633 = true;
         ...
         else if(this.var_173 > _loc1_ - this.var_444 && !this.var_789)
         {
            this.var_978 = false;
            this.var_789 = true;
            this.var_527 = 0;
      ...
      {
         if(param1.position > this.var_1194)
         {
            ++this.var_1785;
         ...
         if(this.var_280 - this.var_173 < _loc2_)
         {
            _loc2_ = this.var_280 - this.var_173;
            if(_loc2_ < 0)
            {
               _loc2_ = 0;
            }
         ...
         this.var_173 += const_118;
         this.var_1194 += const_118;
         if(this.var_446 != null)
         {
            this.var_1478 = param1.position / const_119 * 1000 - this.var_446.position;
         }
      ...
      private function writeAudioToOutputStream(param1:ByteArray, param2:int) : void
      {
         ...
         if(param2 > 0)
         {
            ...
            else
            {
               if(this.var_978)
               {
                  _loc5_ = 1 / this.var_788;
                  _loc6_ = this.var_976 / Number(this.var_788);
                  this.var_976 += const_118;
                  if(this.var_976 > this.var_788)
                  {
                     this.var_978 = false;
                  }
               }
               else if(this.var_789)
               {
                  _loc5_ = -1 / this.var_444;
                  _loc6_ = 1 - this.var_527 / Number(this.var_444);
                  this.var_527 += const_118;
                  if(this.var_527 > this.var_444)
                  {
                     this.var_527 = this.var_444;
                  }
               }
      ...
      {
         this.stopImmediately();
         this._events.dispatchEvent(new SoundCompleteEvent(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.var_1473));
      }
