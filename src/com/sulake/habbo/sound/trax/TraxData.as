package com.sulake.habbo.sound.trax
{
   ...
   public class TraxData
   {
      ...
      public function TraxData(param1:String)
      {
         ...
         if(_loc4_.indexOf("meta") != -1)
         {
            ...
            while(_loc7_ < _loc6_.length)
            {
               ...
               this.var_1352.add(_loc8_,_loc9_);
               _loc7_++;
            }
      ...
      public function getSampleIds() : Array
      {
         ...
         var _loc1_:* = [];
         var _loc2_:int = 0;
         while(_loc2_ < this.var_1351.length)
         {
            _loc3_ = this.var_1351[_loc2_] as TraxChannel;
            _loc4_ = 0;
      ...
      {
         return this.var_1352["meta"] != null;
      }
      
      public function get metaCutMode() : Boolean
      {
         return this.var_1352["c"] == "1";
      }
      
      public function get metaTempo() : int
      {
         return this.var_1352["t"] as int;
      }
   }
}
