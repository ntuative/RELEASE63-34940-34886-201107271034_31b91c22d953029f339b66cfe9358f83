package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1468:int = HabboMusicPrioritiesEnum.const_122;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_781.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_781.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_781)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_846,this.onJukeboxInit);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_247,this.onJukeboxDispose);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_995,this.onSoundMachineInit);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_936,this.onSoundMachineDispose);
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1780)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_94)
            {
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_846,this.onJukeboxInit);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_247,this.onJukeboxDispose);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_995,this.onSoundMachineInit);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_936,this.onSoundMachineDispose);
            }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         if(this.var_330[param1] == null)
         {
            return -1;
         }
         var _loc2_:SongStartRequestData = this.var_330[param1];
      ...
      {
         var _loc1_:int = this.var_330.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_330[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      {
         if(param1 >= 0 && param1 < this.var_375.length)
         {
            return this.var_375.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_375.length)
         {
            return this.var_375.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_278.length)
         {
            ...
            if(_loc3_.id != this.var_1470 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_330[_loc2_] != null)
            {
               _loc3_ = this.var_330[_loc2_];
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_785));
         Logger.log("Requested song info\'s : " + this.var_785);
         this.var_785 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               while(this.var_784.indexOf(_loc6_.id) != -1)
               {
                  this.var_784.splice(this.var_784.indexOf(_loc6_.id),1);
      ...
      private function playSongObject(param1:int, param2:int) : Boolean
      {
         ...
         this.var_1780 = this.getSongRequestCountAtPriority(param1);
         this.var_1470 = param2;
         if(this._priorityPlaying <= const_1468)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2391 != param1.id || _loc3_ > this.var_2390 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2391 = param1.id;
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_526 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_94,this._connection) as IPlayListController;
      }
