package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_258 = param2;
         this.var_781 = [];
         this.var_781.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_781.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_781)
         {
         ...
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_906,this.onSoundMachinePlayEvent);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_850,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_94)
            {
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_906,this.onSoundMachinePlayEvent);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_850,this.onSoundMachineStopEvent);
               this.var_94 = null;
            }
            this._disposed = true;
         }
      ...
      public function stopPlaying() : void
      {
         this.var_448 = -1;
         this.var_635 = false;
         this.var_258.stop(HabboMusicPrioritiesEnum.const_122);
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_258.playSong(param1,HabboMusicPrioritiesEnum.const_122,_loc3_,0,0,0))
         {
