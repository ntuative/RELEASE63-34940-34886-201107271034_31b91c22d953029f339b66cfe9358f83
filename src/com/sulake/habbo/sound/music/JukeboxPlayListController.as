package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController implements IPlayListController
   {
      ...
      public function JukeboxPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_781 = [];
         this.var_781.push(new NowPlayingMessageEvent(this.onNowPlayingMessage));
         this.var_781.push(new JukeboxSongDisksMessageEvent(this.method_4));
         this.var_781.push(new JukeboxPlayListFullMessageEvent(this.onJukeboxPlayListFullMessage));
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_635 = _loc3_.currentSongId != -1;
         if(_loc3_.currentSongId >= 0)
         {
            this.var_258.playSong(_loc3_.currentSongId,HabboMusicPrioritiesEnum.const_122,_loc3_.syncCount / 1000,0,1,1);
         ...
         this.var_1779 = _loc3_.currentPosition;
      ...
      private function method_4(param1:IMessageEvent) : void
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc7_:* = null;
         ...
         while(_loc4_ < _loc3_.songDisks.length)
         {
            ...
            if(_loc7_ == null)
            {
               ...
               if(this.var_782.indexOf(_loc5_) < 0)
               {
                  this.var_782.push(_loc5_);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         var _loc3_:int = this.var_782.indexOf(param1.id);
         if(_loc3_ >= 0)
         {
            this.var_782.splice(_loc3_,1);
         }
         if(this.var_782.length == 0)
         {
            this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.const_104));
