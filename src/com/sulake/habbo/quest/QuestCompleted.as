package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      private static const const_1654:int = 31;
      ...
      public function prepare(param1:QuestMessageData) : void
      {
         ...
         this._window.findChildByName("catalog_link_txt").caption = this.var_50.localization.getKey("quests.completed.cataloglink." + this.var_140.activityPointType);
         var _loc2_:String = "quests.completed.reward." + this.var_140.activityPointType;
         this.var_50.localization.registerParameter(_loc2_,"amount",this.var_140.rewardCurrencyAmount.toString());
         this._window.findChildByName("reward_txt").caption = this.var_50.localization.getKey(_loc2_,_loc2_);
         this._window.visible = false;
         this._window.findChildByName("congrats_txt").caption = this.var_50.localization.getKey(!!this.var_140.lastQuestInCampaign ? "quests.completed.campaign.caption" : "quests.completed.quest.caption");
         ...
         this.var_50.setupCampaignImage(this._window,param1,this.var_140.lastQuestInCampaign);
         ...
         _loc3_.height = Math.max(const_1654,_loc3_.textHeight + const_1562);
      ...
      {
         this.var_50.localization.registerParameter(param1,"category",this.var_50.getCampaignName(this.var_140));
