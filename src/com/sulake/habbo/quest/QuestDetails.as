package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1500:int = 56;
      
      private static const const_484:int = 5;
      
      private static const const_1562:int = 5;
      
      private static const const_1091:Point = new Point(8,8);
      
      private static const const_1561:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER","PET_DRINK","PET_EAT"];
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         if(this._window == null)
         {
            ...
            _loc8_.x = const_1091.x;
            _loc8_.y = const_1091.y;
         ...
         if(!_loc2_)
         {
            ...
            _loc3_.height = _loc3_.textHeight + const_1562;
         }
         _loc3_.visible = !_loc2_;
         var _loc5_:int = this.getTextHeight(_loc3_) - _loc4_;
         var _loc6_:int = this.setupLink("link_region",_loc3_.y + _loc3_.height + const_484);
         ...
         this._window.height = _loc8_.height + const_1500;
      ...
      private function setupLink(param1:String, param2:int) : int
      {
         ...
         {
            _loc7_ = const_484 + _loc6_.height;
         }
         if(!_loc5_ && _loc6_.visible)
         {
            _loc7_ = -const_484 - _loc6_.height;
      ...
      {
         return this.var_140.waitPeriodSeconds < 1 && const_1561.indexOf(this.var_140.type) > -1;
      }
      
      private function hasNavigatorLink() : Boolean
      {
         var _loc1_:Boolean = this.var_50.localization.hasKey(this.var_140.getCampaignLocalizationKey() + ".searchtag");
         var _loc2_:Boolean = this.var_50.localization.hasKey(this.var_140.getCampaignLocalizationKey() + ".searchtag");
         return this.var_140.waitPeriodSeconds < 1 && (_loc1_ || _loc2_);
      }
      ...
      private function onLinkProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this.var_50.openCatalog(this.var_140);
            }
            else if(this.hasNavigatorLink())
            {
               this.var_50.openNavigator(this.var_140);
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1464 = NextQuestTimer.const_1000;
         var _loc2_:Boolean = this.var_50.questController.questsList.refreshDelay(this._window,this.var_140);
         if(_loc2_)
         {
