   ...
   public class Animation implements IDisposable
   {
      ...
      private function draw() : void
      {
         ...
         if(this.var_1184)
         {
            ...
            {
               if(!_loc2_.isFinished(this.var_970))
               {
                  _loc1_ = true;
                  _loc3_ = _loc2_.getBitmap(this.var_970);
                  if(_loc3_ != null)
                  {
                     this.var_101.bitmap.copyPixels(_loc3_,_loc3_.rect,_loc2_.getPosition(this.var_970));
                  }
               }
            }
         }
         this.var_101.invalidate(this.var_101.rectangle);
         this.var_1184 = _loc1_;
      }
   }
}
