package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1677:int = 5;
      
      private static const const_1680:int = 800;
      
      private static const const_1679:int = 15;
      
      private static const const_1678:int = 300;
      ...
      private var var_1363:QuestController;
      
      private var var_1113:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1363 = new QuestController(this);
         this.var_1113 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1677);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_415.events.removeEventListener(BadgeImageReadyEvent.const_230,this.var_1113.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_415.events.addEventListener(BadgeImageReadyEvent.const_230,this.var_1113.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1363.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_1113.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1363.questTracker.isVisible();
      }
      ...
      {
         this.var_1363.update(param1);
         this.var_1113.update(param1);
      }
