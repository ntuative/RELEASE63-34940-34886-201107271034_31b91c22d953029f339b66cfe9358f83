package com.sulake.habbo.quest
{
   ...
   public class NextQuestTimer implements IDisposable
   {
      ...
      public static const const_1000:int = 1000;
      ...
      private function refresh() : void
      {
         ...
         if(_loc1_ < 1)
         {
            ...
            this.var_50.questController.onQuest(this.var_140);
         }
         ...
         this._window.findChildByName("quest_header_txt").caption = this.var_50.localization.getKey("quests.nextquesttimer.caption." + (!!this.var_523 ? "expanded" : "contracted"));
      ...
      {
         this._window.findChildByName("quest_timer_expanded").visible = this.var_523;
         this._window.findChildByName("quest_timer_contracted").visible = !this.var_523;
         this._window.findChildByName("more_info_txt").visible = this.var_523 && this.var_50.currentlyInRoom;
         this._window.findChildByName("more_info_region").visible = this.var_523 && this.var_50.currentlyInRoom;
         this._window.findChildByName("quest_pic_bitmap").visible = this.var_523;
         this._window.findChildByName("desc_txt").visible = this.var_523;
         this.refresh();
      }
      ...
      private function onMoreInfo(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this.var_50.questController.questDetails.showDetails(this.var_140);
         }
      }
