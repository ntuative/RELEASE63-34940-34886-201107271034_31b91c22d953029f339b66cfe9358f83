package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends ComponentContext implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1173:IRoomWidgetFactory;
      ...
      private var var_1708:IHabboAvatarEditor = null;
      ...
      private var var_1261:IHabboHelp;
      
      private var var_1022:IHabboModeration;
      ...
      private var var_1260:IHabboUserDefinedRoomEvents;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1537 = RoomDesktop.const_619;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1261.release(new IIDHabboHelp());
            this.var_1261 = null;
         }
         ...
         {
            this.var_1022.release(new IIDHabboModeration());
            this.var_1022 = null;
         }
         ...
         if(this.var_1260)
         {
            this.var_1260.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1260 = null;
         }
         this.var_1708 = null;
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1708 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_343.events.addEventListener(InterstitialEvent.const_590,this.interstitialCompleteEventHandler);
            this.var_343.events.addEventListener(InterstitialEvent.const_660,this.adEventHandler);
            this.var_343.events.addEventListener(AdEvent.const_622,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1261 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1022 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_1022);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            ...
            this.var_15.events.addEventListener(RoomSessionEvent.const_70,this.roomSessionStateEventHandler);
            this.var_15.events.addEventListener(RoomSessionEvent.const_86,this.roomSessionStateEventHandler);
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_208,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_538,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPresentEvent.const_379,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_640,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_591,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_509,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_545,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_802,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1263,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1413,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1029,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_930,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_921,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_586,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionFriendRequestEvent.const_95,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionUserNotificationEvent.const_131,this.roomSessionEventHandler);
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_70:
               this._toolbar.setToolbarState(HabboToolbarEnum.const_752);
               break;
            case RoomSessionEvent.const_86:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.setToolbarState(HabboToolbarEnum.const_893);
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_294:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_802:
            ...
            case RoomSessionErrorMessageEvent.const_274:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_1029:
               errorMessage = "${room.error.pets.forbidden_in_hotel}";
               break;
            case RoomSessionErrorMessageEvent.const_930:
      ...
      private function interstitialCompleteEventHandler(param1:InterstitialEvent) : void
      {
         ...
         var _loc2_:String = this.getRoomIdentifier(this._interstitialRoomId,this.var_2572);
      ...
      private function onUserDefinedRoomEventsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1260 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_844,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_1001,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_767,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_844)
         {
            if(this.var_15 != null)
            {
               this.var_15.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_506 || param1.type == RoomEngineEvent.const_633)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_185:
               ...
               _loc3_.disposeWidget(RoomWidgetEnum.const_631);
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_834);
               ...
               if(this.var_1537 != RoomDesktop.const_619)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_329,this.var_1537);
               }
               if(this.var_343 != null)
               {
            ...
            case RoomEngineEvent.const_350:
               ...
               break;
            case RoomEngineRoomColorEvent.const_1001:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         if(_loc3_.showInterstitial())
         {
            ...
            this.var_2572 = param1.roomCategory;
         }
         else
         {
            this.var_1538 = false;
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != RoomDesktop.const_619)
            {
               this.var_1537 = _loc3_;
            }
            _loc2_.dispose();
            this.var_1538 = false;
         }
