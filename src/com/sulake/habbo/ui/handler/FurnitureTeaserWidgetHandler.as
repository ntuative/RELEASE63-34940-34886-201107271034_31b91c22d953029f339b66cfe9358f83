package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_744,RoomWidgetViralFurniMessage.const_828,RoomWidgetViralFurniMessage.const_195];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_744:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_621);
                     _loc8_ = "+";
               ...
               break;
            case RoomWidgetViralFurniMessage.const_828:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_509,RoomSessionViralFurniStatusEvent.const_545];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_509:
               ...
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_917);
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_545:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
