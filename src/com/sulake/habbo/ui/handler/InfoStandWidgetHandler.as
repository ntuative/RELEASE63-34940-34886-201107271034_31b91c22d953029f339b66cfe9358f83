package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_258.events.addEventListener(NowPlayingEvent.const_102,this.onNowPlayingChanged);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_187,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_230,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_187,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_230,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_258 != null)
         {
            this.var_258.events.removeEventListener(NowPlayingEvent.const_102,this.onNowPlayingChanged);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_553);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_986);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_938);
         _loc1_.push(RoomWidgetFurniActionMessage.const_826);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1403);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_966);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_1033);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_855);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_2005);
         _loc1_.push(RoomWidgetPetCommandMessage.const_630);
         _loc1_.push(RoomWidgetPetCommandMessage.const_840);
         _loc1_.push(RoomWidgetUserActionMessage.const_592);
         _loc1_.push(RoomWidgetUserActionMessage.const_262);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_948);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_585)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_262 || param1.type == RoomWidgetUserActionMessage.const_592 || param1.type == RoomWidgetUserActionMessage.const_577)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_553:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_986:
            ...
            case RoomWidgetUserActionMessage.const_594:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1226,_loc3_.name);
            ...
            case RoomWidgetFurniActionMessage.const_253:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_938:
            ...
            case RoomWidgetFurniActionMessage.const_826:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_1403:
            ...
            case RoomWidgetUserActionMessage.const_262:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_966:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_1033:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_855:
            ...
            case RoomWidgetUserActionMessage.const_644:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_840:
            ...
            case RoomWidgetPetCommandMessage.const_630:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_948:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_407) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_407);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_1027) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1272;
               }
               ...
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1334);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_609)
                  {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_535)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_362);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_154)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_863);
                  ...
                  _loc14_.name_3 = this._container.sessionDataManager.isAnyRoomController;
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_755;
                  }
                  if(!_loc35_)
                  {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1926);
               }
               else
               {
                  _loc15_ = this._container.roomSession.userDataManager.method_6(_loc12_.webID);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_258 != null)
         {
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_447,_loc2_,_loc3_,_loc4_));
         }
      }
