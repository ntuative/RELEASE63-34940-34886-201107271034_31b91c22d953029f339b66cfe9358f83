package com.sulake.habbo.ui.handler
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      private static const const_491:int = 50;
      
      private static const const_1170:int = 3;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_367,this.onFigureUpdate);
            }
            if(this.var_12 && !this.var_12.disposed && this.var_12.events)
            {
               this.var_12.events.removeEventListener(HabboInventoryEffectsEvent.const_255,this.onAvatarEffectsChanged);
               this.var_12.events.removeEventListener(HabboInventoryHabboClubEvent.const_351,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_1021,this.onHelpTutorialEvent);
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_367,this.onFigureUpdate);
         }
         this.var_12 = this._container.inventory;
         if(this.var_12 != null)
         {
            this.var_12.events.addEventListener(HabboInventoryEffectsEvent.const_255,this.onAvatarEffectsChanged);
            this.var_12.events.addEventListener(HabboInventoryHabboClubEvent.const_351,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_1021,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1683)
            {
               ...
               this.var_2155 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_2154;
               _loc2_ = this.var_2155;
            }
         }
         if(this._toolbar != null)
         {
            ...
            {
               if(_loc1_.height > const_491)
               {
                  _loc7_ = new BitmapData(_loc1_.width,const_491,true,0);
                  _loc8_ = _loc7_.rect.clone();
                  if(_loc2_.height > const_491 - const_1170)
                  {
                     _loc8_.offset(0,_loc2_.height - const_491 + const_1170);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_813);
         _loc1_.push(RoomWidgetDanceMessage.const_772);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_768);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1333);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1391);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1289);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_872);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_1041);
         _loc1_.push(RoomWidgetStopEffectMessage.const_829);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_2021);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1246);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_521);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1802);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1344);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_978);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_781);
         _loc1_.push(RoomWidgetMeMenuMessage.const_962);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_895);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1906);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1006);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1037);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_781:
               ...
               break;
            case RoomWidgetWaveMessage.const_813:
            ...
            case RoomWidgetDanceMessage.const_772:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_768:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1333:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1391:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_1041:
            ...
            case RoomWidgetOpenInventoryMessage.const_872:
               ...
               if(this.var_12 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1937:
                        this._catalog.openCatalogPage(CatalogPageName.const_1399,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1241:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_228);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1870:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_74);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1974:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1289:
            case RoomWidgetStopEffectMessage.const_829:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1246:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_978:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetMeMenuMessage.const_962:
            ...
            case RoomWidgetAvatarEditorMessage.const_521:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_895:
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_134:
               ...
               break;
            case HabboHelpTutorialEvent.const_1021:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_578));
         }
      }
