package com.sulake.habbo.ui.handler
{
   ...
   public class EffectsWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         {
            this._container.inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_255,this.onEffectsChanged);
         }
         this._container = param1;
         if(this._container != null)
         {
            this._container.inventory.events.addEventListener(HabboInventoryEffectsEvent.const_255,this.onEffectsChanged);
         }
      }
