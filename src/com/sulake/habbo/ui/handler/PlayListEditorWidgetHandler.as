package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1444:IMessageEvent;
      
      private var var_1730:IMessageEvent;
      
      private var var_1729:IMessageEvent;
      ...
      {
         this.var_1444 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1730 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1729 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1444);
         this._connection.addMessageEvent(this.var_1730);
         this._connection.addMessageEvent(this.var_1729);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1444);
               this._connection.removeMessageEvent(this.var_1730);
               this._connection.removeMessageEvent(this.var_1729);
            }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_833,RoomWidgetPlayListModificationMessage.const_819,RoomWidgetPlayListModificationMessage.const_941,RoomWidgetPlayListPlayStateMessage.const_1031,RoomWidgetPlayListUserActionMessage.const_823];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_833:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_819:
            ...
            case RoomWidgetPlayListModificationMessage.const_941:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_1031:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_823:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_247:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_806,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_809,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_916));
               break;
