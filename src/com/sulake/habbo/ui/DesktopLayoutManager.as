package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private static const const_707:String = "room_view";
      
      private static const const_1597:String = "room_widget";
      ...
      private function getWidgetContainer(param1:String, param2:IWindow) : IWindowContainer
      {
         ...
         {
            if(String(_loc3_[_loc5_]).indexOf(const_1597) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_99.getChildByTag(const_707) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_99.findChildByTag(const_707) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
