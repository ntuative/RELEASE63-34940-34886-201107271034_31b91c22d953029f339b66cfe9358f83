package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_1022:String = "MISV_BUY_MORE";
      
      public static const const_765:String = "MISV_PREVIEW_PLAYING";
      ...
      private var var_2192:ITextWindow;
      ...
      {
         if(this.var_2192 == null)
         {
            return;
         }
         this.var_2192.text = param1;
      }
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_2191.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_765,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_1022,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_487.add(const_765,_loc1_);
            this.var_2192 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_2191 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
         ...
         if(_loc1_ != null)
         {
            this.var_487.add(const_1022,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_606));
         }
      }
