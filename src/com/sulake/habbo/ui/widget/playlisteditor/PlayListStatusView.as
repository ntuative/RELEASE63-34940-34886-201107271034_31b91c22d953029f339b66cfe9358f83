package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_756:String = "PLSV_ADD_SONGS";
      
      public static const const_1238:String = "PLSV_START_PLAYBACK";
      
      public static const const_655:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_53 != const_655)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_487[this.var_53];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_487[const_756];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_487.add(const_655,_loc1_);
