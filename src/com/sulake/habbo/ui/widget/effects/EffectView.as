package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectView
   {
      ...
      private const const_2376:int = 1000;
      
      private var _widget:EffectsWidget;
      
      private var _window:IWindowContainer;
      
      private var var_112:IWidgetAvatarEffect;
      
      private var var_652:IWindow;
      
      private var var_322:Number;
      
      private var var_380:ITextWindow;
      
      private var var_212:Timer;
      
      private var var_651:IWindow;
      ...
      public function EffectView(param1:EffectsWidget, param2:IWidgetAvatarEffect)
      {
         ...
         this.var_112 = param2;
         this._widget = param1;
         this.var_212 = new Timer(this.const_2376);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_112.isActive)
         {
            _loc2_ = this.var_112.secondsLeft / Number(this.var_112.duration);
            this.var_652.width = _loc2_ * this.var_322;
         }
         else
         {
            this.var_652.width = 0;
            this.var_212.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_380 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_380 == null)
            {
               return;
            }
         ...
         if(!this.var_112.isActive)
         {
            this.var_380.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         if(this.var_112.secondsLeft > 86400)
         {
            this.var_380.caption = "${widgets.memenu.effects.active.daysleft}";
            _loc1_ = this.var_380.text;
            _loc2_ = Math.floor(this.var_112.secondsLeft / 86400);
            _loc1_ = _loc1_.replace("%days_left%",_loc2_);
         }
         else
         {
            this.var_380.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_380.text;
            _loc3_ = this.var_112.secondsLeft;
      ...
      public function update() : void
      {
         ...
         this.var_380 = null;
         var _loc2_:String = "";
         if(this.var_112.isInUse)
         {
            _loc2_ = "memenu_effect_selected";
         }
         else if(this.var_112.isActive)
         {
         ...
         else
         {
            ...
            this.var_651 = this._window.findChildByName("effect_hilite");
            this.var_651.visible = false;
         }
         this.setTimeLeft();
         this.var_652 = this._window.findChildByName("loader_bar");
         if(this.var_652 != null)
         {
            this.var_322 = this.var_652.width;
            this.var_212.start();
            this.onUpdate();
         }
         if(this.var_112.icon)
         {
            this.setElementBitmap("effect_icon",this.var_112.icon);
         }
      ...
      private function onMouseEvent(param1:WindowMouseEvent) : void
      {
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               this._widget.selectEffect(this.var_112.type,this.var_112.isInUse);
         }
      }
