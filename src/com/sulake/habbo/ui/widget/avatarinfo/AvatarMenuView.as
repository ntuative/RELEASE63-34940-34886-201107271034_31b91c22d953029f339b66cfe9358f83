package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1050:uint = 1;
      
      protected static const const_1051:uint = 2;
      
      protected static var var_1439:uint = const_1050;
      
      private static const const_1639:uint = 16744755;
      
      private static const const_1638:uint = 16756591;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1725)
         {
            ...
            {
               this.var_713 = const_1051;
            }
            else
            {
               this.var_713 = var_1439;
            }
         }
         if(this.var_713 == const_1050)
         {
            ...
            {
               case RoomWidgetUserInfoUpdateEvent.const_755:
         ...
         if(this.var_713 == const_1051)
         {
            this.showButton("ignore",!this._data.isIgnored);
            this.showButton("unignore",this._data.isIgnored);
            this.showButton("kick",(this._data.amIOwner || this._data.amIController || this._data.name_3) && this._data.canBeKicked);
            this.showButton("ban",(this._data.amIOwner || this._data.name_3) && this._data.canBeKicked);
      ...
      private function showButton(param1:String, param2:Boolean = true) : void
      {
         ...
         if(_loc6_)
         {
            ...
            {
               _loc6_.x = _loc5_.x + (_loc5_.width - _loc5_.textWidth) / 2 - _loc6_.width - const_1130;
            }
            if(_loc6_.tags.indexOf("arrow_right") != -1)
            {
               _loc6_.x = _loc5_.x + (_loc5_.width + _loc5_.textWidth) / 2 + const_1130;
            }
         }
      }
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(param2.name == "button")
            {
               param2.color = param2.tags.indexOf("moderate") > -1 ? uint(const_2070) : uint(const_1043);
            }
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1638;
               }
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            ...
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1639;
               }
            }
         }
         if(_loc3_)
