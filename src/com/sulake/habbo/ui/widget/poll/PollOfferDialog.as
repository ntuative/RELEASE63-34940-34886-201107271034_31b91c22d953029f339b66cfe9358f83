package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_2042:String = "POLL_OFFER_STATE_OK";
      
      public static const const_928:String = "POLL_OFFER_STATE_CANCEL";
      ...
      private function onOk(param1:WindowEvent) : void
      {
         ...
         this._state = const_2042;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_909,this._id));
      }
      ...
      private function onCancel(param1:WindowEvent) : void
      {
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_605,this._id));
