package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class SpamWallPostItFurniWidget extends StickieFurniWidget
   {
      ...
      {
         var_2275 = "spamwall_postit_container";
      ...
      {
         param1.addEventListener(RoomWidgetSpamWallPostItEditEvent.const_510,this.onEditPostItRequest);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetSpamWallPostItEditEvent.const_510,this.onEditPostItRequest);
      }
      ...
      override protected function sendUpdate() : void
      {
         ...
         if(var_239 != -1)
         {
            ...
            {
               _loc1_ = new RoomWidgetSpamWallPostItFinishEditingMessage(RoomWidgetSpamWallPostItFinishEditingMessage.const_1007,var_239,this.var_501,_text,var_362);
