package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_682:String = "welcome_gift_email_unverified";
      
      private const const_1053:String = "welcome_gift_email_verified";
      
      private const const_1439:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         {
            this.setViewState(this.const_682);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_682:
               ...
               this._view.findChildByName("edit_text").visible = this.var_949;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_949);
               break;
            ...
            case this.const_1439:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_949);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1441;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1439);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_1030,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1163 ? this.const_1053 : this.const_682);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1442 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1442));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_949,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_949,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_597:
               this.var_1441 = param1.email;
               this.var_1163 = param1.isVerified;
               this.var_949 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1441 = this.var_1442;
            this.setViewState(this.const_682);
         }
         else
         {
            if(param1.result == this.const_2365)
            {
               this.var_949 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1442);
