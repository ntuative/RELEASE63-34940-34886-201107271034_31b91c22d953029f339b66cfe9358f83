package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1103:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_1010 = param1.volume;
         if(this.var_1103 != null)
         {
            this.var_1103.setValue(this.var_1010);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1101 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1102 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1099 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1100 = (_loc5_.content as BitmapData).clone();
         }
         this.var_1103 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_895));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_1010 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1100);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1101);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1099);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1102);
         }
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "sounds_on":
               ...
               break;
            case "back_btn":
               this._widget.changeView(MeMenuWidget.const_856);
               break;
            default:
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_1006);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_1037);
         }
