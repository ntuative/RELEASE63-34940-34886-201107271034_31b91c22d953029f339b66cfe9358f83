package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_309:int = 0;
      
      public static const const_89:int = 39;
      
      private static const const_1103:int = 150;
      ...
      private var var_2647:BitmapData;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_1949 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2647 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1950 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1951 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2651 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2649 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_90 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_344,HabboWindowStyle.const_30,HabboWindowParam.const_64,new Rectangle(0,0,param3.width,param3.height - const_89),null,0,0) as IBitmapWrapperWindow;
         this.var_43.addChild(this.var_90);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_71,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_43.height - const_89,param3.width,const_89),null,0) as IWindowContainer;
         this.var_43.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_365,HabboWindowStyle.const_47,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_89),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_524:
               this.var_90.blend += param1 / const_1102;
               this._window.blend += param1 / const_1102;
               ...
               break;
            case const_1079:
               this.var_90.blend -= param1 / const_1103;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_43.width - this.var_2650;
         }
         if(this.var_90 != null)
         {
            this.var_90.rectangle = this.var_43.rectangle;
            this.var_90.height -= const_89;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2648 == this._window.width)
         {
            return;
         }
         this.var_2648 = this._window.width;
         ...
         {
            barHandle.bitmap = this.var_2647;
            barHandle.disposesBitmap = false;
            barX.bitmap = this.var_1950;
            barX.disposesBitmap = false;
            this.var_2650 = this._window.width - barX.x;
         }
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2652,destBgBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1949,destGripLBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1949,destGripRBitmap);
         ...
         this.var_90.bitmap = this.var_2649;
