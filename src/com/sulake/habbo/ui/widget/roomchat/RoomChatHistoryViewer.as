package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_204.state = RoomChatHistoryPulldown.const_309;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_204.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_309);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_204.state == RoomChatHistoryPulldown.const_403 || this.var_204.state == RoomChatHistoryPulldown.const_524;
      }
      ...
      {
         if(!this.var_467 && !this.var_1925)
         {
            this.var_467 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_204.state = RoomChatHistoryPulldown.const_403;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_54 != null)
         {
            ...
            if(param2)
            {
               this.var_54.scrollV = this.var_678;
            }
         }
         if(this.var_204 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_466 > 0 && param2)
         {
            if(this.var_1973)
            {
               if(Math.abs(param1 - this.var_466) <= const_1234)
               {
                  return;
               }
               this.var_1973 = false;
            ...
            if(this.var_467)
            {
               ...
               _loc5_ = (param1 - this.var_466) / this.var_54.height;
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_54.scrollV < 1 - const_1596 / this.var_54.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1974)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_54 != null)
         {
            this.var_678 = this.var_54.scrollV;
         }
         if(this.var_54 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_678 - this.var_54.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
