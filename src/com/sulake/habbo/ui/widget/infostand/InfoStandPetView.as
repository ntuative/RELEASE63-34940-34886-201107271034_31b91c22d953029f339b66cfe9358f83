package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1720:int = 162;
      
      private static const const_1726:int = 16;
      
      private static const const_732:int = 4;
      
      private static const const_1725:uint = 14342874;
      
      private static const const_1731:uint = 3815994;
      
      private static const const_1724:uint = 2085362;
      
      private static const const_1729:uint = 39616;
      
      private static const const_1721:uint = 10513106;
      
      private static const const_1728:uint = 8734654;
      
      private static const const_1723:uint = 9094430;
      
      private static const const_1733:uint = 6200576;
      
      private static const const_1727:String = "happiness";
      
      private static const const_1722:String = "experience";
      
      private static const const_1732:String = "energy";
      
      private static const const_1730:int = 250;
      
      private static const const_1173:int = 25;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1727,param1.nutrition,param1.nutritionMax,const_1729,const_1724);
         this.updateStateElement(const_1722,param1.experience,param1.experienceMax,const_1728,const_1721);
         this.updateStateElement(const_1732,param1.energy,param1.energyMax,const_1733,const_1723);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1720,const_1726,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1725);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1731);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_235 && this.var_235.getPetId() == this.var_532)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1894,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_394,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1173 + const_1174;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1174;
            }
         }
         this.var_108.height = _loc4_ + const_1173;
         this.updateWindow();
      }
   }
}
