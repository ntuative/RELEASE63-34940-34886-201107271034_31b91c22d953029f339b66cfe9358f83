package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2370:int = 5;
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(this.var_1169 + param1.height > this.var_1170.height)
         {
            return false;
         }
         ...
         {
            this._offsetX = 0;
            this.var_1169 += param1.height + this.const_2369;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1169);
         this._offsetX += param1.width + this.const_2370;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1453 != null && this.var_1453.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_176);
