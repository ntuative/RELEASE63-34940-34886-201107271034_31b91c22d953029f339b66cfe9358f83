package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         var_269 = var_48.findChildByTag("catalog");
         if(var_269 != null)
         {
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_447)
         {
            this.var_1473 = param1.songId;
         }
         if(param1.songId == this.var_1473)
         {
            this._songName = param1.songName;
            this.var_2742 = param1.songAuthor;
            this.updateNowPlaying(this.var_1473 >= 0);
         }
      }
      ...
      private function updateNowPlaying(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2742;
         }
         else
         {
