package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetData
   {
      ...
      public function setData(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_1752 = param1.id;
         this._type = param1.petType;
         this.var_2622 = param1.petRace;
         this.var_49 = param1.image;
         this.var_2577 = param1.isOwnPet;
         this.var_2359 = param1.ownerId;
         this._ownerName = param1.ownerName;
         this._canOwnerBeKicked = param1.canOwnerBeKicked;
         this.var_1409 = param1.level;
         this.var_2526 = param1.levelMax;
         this.var_2358 = param1.experience;
         this.var_2527 = param1.experienceMax;
         this._energy = param1.energy;
         this.var_2529 = param1.energyMax;
         this._nutrition = param1.nutrition;
         this.var_2528 = param1.nutritionMax;
         this._petRespect = param1.petRespect;
         this.var_2495 = param1.roomIndex;
