package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_379 = new Timer(this.const_2374);
         this.var_379.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1215.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1215.getValue(this.var_532) as CommandConfiguration;
      ...
      {
         this.var_1215.remove(param1);
         this.var_1215.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_840,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_41.position = const_1494;
      }
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_262,this.var_532));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_630,this.var_532,this.var_1824 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_630,this.var_532,this.var_1824 + " " + _loc5_);
