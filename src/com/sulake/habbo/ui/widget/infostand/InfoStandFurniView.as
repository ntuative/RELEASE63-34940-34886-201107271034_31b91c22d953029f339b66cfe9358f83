package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_269 = this.var_48.findChildByTag("catalog");
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc5_.name)
         {
            ...
            case "save_branding_configuration":
               break;
            case "HabboAvatarRenderLib_pet_placeholder_s2_png":
               _loc3_ = "null";
         }
         if(_loc3_ != null)
         {
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_1272 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_609 && param1.isRoomOwner)
         {
         ...
         this.showButton("HabboAvatarRenderLib_pet_placeholder_s2_png",_loc6_);
      ...
      private function getAdFurnitureExtraParams() : Map
      {
         ...
         {
            _loc2_ = this._widget.furniData.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_1185.length);
            _loc3_ = _loc2_.split("\t");
            if(_loc3_ != null)
            {
