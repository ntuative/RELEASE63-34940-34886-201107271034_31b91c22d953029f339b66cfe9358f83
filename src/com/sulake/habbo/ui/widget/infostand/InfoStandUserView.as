package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private const const_1117:int = 5;
      
      private const const_2383:int = 3;
      
      private const const_1603:int = 11184810;
      
      private const const_1602:int = 16777215;
      
      private const const_2384:int = 2000;
      
      private const const_2385:int = 50;
      
      private const const_2382:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_2697 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1117;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1603;
            }
            else
            {
               _loc5_.textColor = this.const_1602;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1117,this.const_2385);
         _loc5_.height = Math.max(_loc5_.height,this.const_2382);
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_154:
               ...
               if(this.var_2697)
               {
                  ...
                  this.showButton("kick",(param1.amIOwner || param1.amIController || param1.name_3) && param1.canBeKicked);
                  this.showButton("ban",(param1.amIOwner || param1.name_3) && param1.canBeKicked);
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2696 > this.const_2384 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2696 = _loc6_;
               _loc3_.textColor = this.const_1602;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1603;
         }
      }
