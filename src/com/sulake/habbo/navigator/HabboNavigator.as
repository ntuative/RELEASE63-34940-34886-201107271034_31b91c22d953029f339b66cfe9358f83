package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_357:MainViewCtrl;
      
      private var var_749:RoomInfoViewCtrl;
      
      private var var_1404:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_451:Tabs;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_357 = new MainViewCtrl(this);
         this.var_749 = new RoomInfoViewCtrl(this);
         this.var_1404 = new RoomCreateViewCtrl(this);
         this.var_2874 = new RoomThumbnailRenderer(this);
         this.var_1084 = new GuestRoomPasswordInput(this);
         this.var_326 = new GuestRoomDoorbell(this);
         this.var_451 = new Tabs(this);
         this.var_1403 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_344,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_357.onNavigatorToolBarIconClick();
            }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_357.startSearch(Tabs.const_265,Tabs.const_675,param1);
         this.trackNavigationDataPoint("Search","search.tag",param1);
         this.var_357.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_357.startSearch(Tabs.const_315,Tabs.const_261);
         this.var_451.getTab(Tabs.const_315).tabPageDecorator.tabSelected();
      }
