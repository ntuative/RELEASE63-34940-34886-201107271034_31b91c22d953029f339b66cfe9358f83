package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_470)
         {
            this.var_470.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_470.reset();
            this.var_470 = null;
         }
         if(this.var_393)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_59 == null)
         {
            this.var_59 = IWindowContainer(this._navigator.getXmlWindow(this.var_1157));
         ...
         this.var_59.x = _loc2_.x + this.var_2678 + param1.width;
