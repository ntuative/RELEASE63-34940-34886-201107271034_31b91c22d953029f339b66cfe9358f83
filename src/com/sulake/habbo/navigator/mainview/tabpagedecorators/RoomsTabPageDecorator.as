package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_231,Tabs.const_432);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_231,Tabs.const_967);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_231,Tabs.const_432,"" + _loc3_);
         }
         if(this.var_152)
         {
