package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      public static const const_559:int = 10;
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_1057 / 2);
         return new Point(param1 * const_1057 + _loc3_,param2 * const_1459);
      }
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("bitmap","",HabboWindowType.const_344,HabboWindowStyle.const_47,0 | (!!param3 ? HabboWindowParam.const_44 : HabboWindowParam.const_47),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_964.getImage(ThumbnailEditorModel.const_37,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_964.getImage(ThumbnailEditorModel.const_37,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_964.getImage(ThumbnailEditorModel.const_65,param2);
         if(_loc3_ == null)
         {
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         ...
         {
            this.var_1458 = this._navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(this.var_1458,this.var_1458.rect,new Point(0,0),null,null,true);
      }
      
      private function refreshObj(param1:BitmapData, param2:RoomThumbnailObjectData) : void
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_964.getImage(ThumbnailEditorModel.const_34,param2.imgId);
         if(_loc3_ == null)
         {
