package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1745:IButtonWindow;
      
      private var var_2332:IWindowContainer;
      
      private var var_2333:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1744 = IButtonWindow(this.find("bg_tab"));
         this.var_1743 = IButtonWindow(this.find("top_tab"));
         this.var_1745 = IButtonWindow(this.find("obj_tab"));
         this.var_2332 = IWindowContainer(this.find("tile_grid"));
         this.var_2333 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1744,this.onBgTabButton);
         Util.setProcDirectly(this.var_1743,this.onTopTabButton);
         Util.setProcDirectly(this.var_1745,this.onObjTabButton);
      }
      ...
      {
         this.setEnabled(this.var_1744,this.var_78.mode != ThumbnailEditorModel.const_37);
         this.setEnabled(this.var_1743,this.var_78.mode != ThumbnailEditorModel.const_65);
         this.setEnabled(this.var_1745,this.var_78.mode != ThumbnailEditorModel.const_34);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2333;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2332;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_559)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_344,HabboWindowStyle.const_47,HabboWindowParam.const_64,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
