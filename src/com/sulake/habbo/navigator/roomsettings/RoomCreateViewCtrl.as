package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1216:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_646 = new Timer(100);
         this.var_646.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
      ...
      public function dispose() : void
      {
         if(this.var_646)
         {
            this.var_646.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_646.reset();
            this.var_646 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1216.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1825 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1825 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_63 = IItemListWindow(this.var_199.findChildByName("item_list"));
         ...
         this.var_1217 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_199.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1217.goBackToInitialState();
         this.var_1217.input.textBackgroundColor = 4294967295;
         this.var_1216 = this.var_45[0];
         this.refreshRoomThumbnails();
      ...
      private function addThumbnail(param1:IWindowContainer, param2:RoomLayout, param3:Boolean) : void
      {
         ...
         this.addMouseClickListener(_loc4_,this.method_5);
      ...
      {
         return Boolean(this.var_1217.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      private function method_5(param1:WindowEvent) : void
      {
      ...
      {
         var _loc2_:String = this.var_1217.getText();
         var _loc3_:String = "model_" + this.var_1216.name;
