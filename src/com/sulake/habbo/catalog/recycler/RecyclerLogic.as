package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_663 != const_1090;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1908 != RecyclerStatusMessageEvent.const_1224;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_663 == const_477;
      }
      ...
      {
         this.var_663 = const_1089;
         this.var_134 = new Array(const_229);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_2000:
               this.var_663 = const_477;
            ...
            case RecyclerStatusMessageEvent.const_1224:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1942:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1376:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_2010:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_134.length < const_229)
         {
            return false;
         }
         var _loc1_:int = 0;
