package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2099:uint = 4.293848814E9;
      
      private const const_2098:uint = 4.294967295E9;
      
      private const const_1484:uint = 4.291613146E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1402 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            _loc7_.addEventListener(WindowEvent.const_337,this.onMessageInputFocus);
         }
         this.var_2201 = true;
         this.var_2202 = true;
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               _loc12_.addEventListener(WindowEvent.const_376,this.onFreeWrappingSelected);
               _loc12_.addEventListener(WindowEvent.const_426,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_2203 = _loc1_.stuffTypes;
            this.var_920 = _loc1_.boxTypes;
            this.var_922 = _loc1_.ribbonTypes;
            this.var_1401 = this.var_2203[0];
            this.var_425 = this.var_920[0];
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_425 < 0)
         {
            this.var_425 = this.var_920.length - 1;
         }
         if(this.var_425 > this.var_920.length - 1)
         {
            this.var_425 = 0;
         }
         var _loc1_:int = this.var_920[this.var_425] * 1000 + this.var_922[this.var_424];
         if(this._window == null)
         {
            return;
         }
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_2203)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_920[this.var_425]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_922[this.var_424]);
         this._catalog.purchaseProductAsGift(this.var_1704,this.var_1402,this.var_1702,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1704,this.var_1402,this.var_1702);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         if(this.var_3029 == _loc2_.text)
         {
            return;
         }
         var _loc3_:String = _loc2_.text.toLowerCase();
         var _loc4_:* = [];
         for each(_loc5_ in this.var_245)
         {
            if(_loc5_.toLowerCase().search(_loc3_) != -1)
            {
               _loc4_.push(_loc5_);
            }
            if(_loc4_.length >= this.const_2404)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_3029 = _loc2_.text;
      }
      ...
      private function onNameInputKeyUp(param1:WindowEvent) : void
      {
         ...
         {
            case Keyboard.UP:
               this.highlightSuggestion(this.var_426 - 1);
               break;
            case Keyboard.DOWN:
               this.highlightSuggestion(this.var_426 + 1);
               break;
      ...
      {
         if(this.var_311 == null || !this.var_311.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_311.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_426) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_311 == null)
         {
            this.var_311 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_921 == null)
         {
            this.var_921 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_311 == null || this.var_921 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_311.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_921.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_311.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_426) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_426);
         }
         this.var_426 = param1;
         if(this.var_426 < 0)
         {
            this.var_426 = _loc2_.numListItems - 1;
         }
         if(this.var_426 >= _loc2_.numListItems)
         {
            this.var_426 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_426) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1484;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2099) : uint(this.const_2098);
      }
