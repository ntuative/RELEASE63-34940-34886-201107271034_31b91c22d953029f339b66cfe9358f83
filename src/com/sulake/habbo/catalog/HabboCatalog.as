package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private var var_1354:IRoomSession;
      ...
      private var var_1659:IDragAndDropDoneReceiver;
      ...
      private var var_724:RoomPreviewer;
      
      private const const_2102:Point = new Point(100,20);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            this.var_15.events.removeEventListener(RoomSessionEvent.const_70,this.onRoomSessionEvent);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2906 = this.isNewItemsNotificationEnabled();
      ...
      private function initializeRoomPreviewer() : void
      {
         if(this._roomEngine != null && this.var_144 != null && this.var_144.getKey("catalog.furniture.animation","false") == "true")
         {
            if(this.var_724 == null)
            {
               this.var_724 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_867 || !this.var_262 || !this.var_262.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_1108 = -1;
            this.var_895 = param1;
      ...
      {
         var _loc2_:Array = this.var_896.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer.position = this.const_2102;
         this.hideMainWindow();
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_70:
               this.var_2117 = param1.session.isPrivateRoom;
               this.var_1354 = param1.session;
               if(this.var_106 != null)
               {
      ...
      private function createClubExtendController() : void
      {
         if(this.var_723 == null)
         {
            this.var_723 = new ClubExtendController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1658 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_262.buildCatalogIndex(_loc2_);
         if(this.var_895 && this.var_895 != "")
         {
            this.var_262.openPage(this.var_895);
            this.var_895 = "";
            this.var_1108 = -1;
         }
         else if(this.var_1108 > -1)
         {
            this.var_262.openPageById(this.var_1108,this.var_2116);
            this.var_1108 = -1;
            this.var_2116 = -1;
            this.var_895 = "";
         }
         else if(this.var_1658 && this.var_2906)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_262.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1856));
         }
         else
         {
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2909 && this._soundManager != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_128,this.var_115.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2907 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1320);
         }
         this.var_2907 = false;
         if(this.var_228 != null && !this.var_228.disposed)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_345,_loc2_.amount));
         }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_345,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_115.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1401 ? true : false;
         this.updatePurse();
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2908 = new GiftWrappingConfiguration(param1);
      }
      ...
      {
         if(this.var_723 != null && this.var_144.getBoolean("club.membership.extend.promotion.enabled",false))
         {
            this.var_723.onOffer(param1);
         }
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_896.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_896.add(_loc2_.productCode,_loc3_.slice());
      ...
      public function isDraggable(param1:Offer) : Boolean
      {
         ...
         if(!this.var_1354 || !this.var_1354.isRoomOwner)
         {
            return false;
         }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1357 && param1.type == RoomEngineObjectEvent.const_173)
         {
            this.resetPlacedOfferData(true);
            if(this.var_894 == null || this.var_894.disposed)
            {
            ...
            this.var_67 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_894);
            _loc5_ = this.var_1659;
            if(_loc5_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_724 != null)
         {
            this.var_724.updatePreviewRoomView();
         }
      }
   }
}
