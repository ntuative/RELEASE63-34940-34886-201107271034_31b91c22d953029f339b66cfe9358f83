package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         {
            if(_loc4_ > this.var_645)
            {
               this.var_645 = _loc4_;
            }
         }
         _loc5_ = Math.pow(10,int(this.var_645).toString().length - 1);
         this.var_645 = Math.ceil(this.var_645 / _loc5_) * _loc5_;
         ...
         _loc6_.text = this.var_645.toString();
         _loc3_.draw(_loc6_);
         this.var_1212 = param1 - _loc6_.textWidth - 2;
         ...
         while(_loc10_ <= 5)
         {
            ...
            _loc9_.graphics.lineTo(this.var_1212 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_1212,(param2 - this.var_989) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_1212 + this.var_1212 / -this.var_3089 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_989 - this.var_989 / this.var_645 * this.var_182[param1];
      }
