package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_531:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1208:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_531 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1209);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1209);
      }
      ...
      protected function createWindow(param1:String) : Boolean
      {
         ...
         this.var_2269 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2269) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1800:
               if(this.var_1208 == null)
               {
                  this.var_1208 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_38.push(this.var_1208);
               }
               break;
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_531.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_531 != null)
         {
            return this.var_531.dispatchEvent(param1);
         }
         return false;
      }
