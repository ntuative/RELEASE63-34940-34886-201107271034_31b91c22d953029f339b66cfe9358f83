package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1129:String = "bg";
      ...
      {
         this._view.getChildByName(const_1129).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1129).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_91,MouseCursorType.const_945);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_945);
         }
      }
