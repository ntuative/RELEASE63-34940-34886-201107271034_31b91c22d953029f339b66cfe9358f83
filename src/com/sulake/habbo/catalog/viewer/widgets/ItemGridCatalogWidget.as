package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_233:Boolean = true;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_932,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_310,this.deActivateScrollbar);
         }
         this.var_33 = param2;
      }
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_771 >= 0 && this.var_771 < _loc2_)
               {
                  _loc4_ = page.offers[this.var_771];
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1789) as IWindowContainer;
         ...
         {
            ++this.var_1742;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1742);
         }
      }
