package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_637 = this.recycler.getPrizeTable();
         ...
         if(this.var_637.length > 0 && this.var_637[0].prizes.length > 0)
         {
            this.select(this.var_637[0].prizes[0] as IGridItem);
         }
         return true;
      }
      ...
      private function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            this.createLevelItem(this.var_637[_loc2_]);
            _loc2_++;
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1790) as IWindowContainer;
      ...
      private function createPrizeItem(param1:PrizeContainer, param2:IItemGridWindow) : void
      {
         ...
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1789) as IWindowContainer;
