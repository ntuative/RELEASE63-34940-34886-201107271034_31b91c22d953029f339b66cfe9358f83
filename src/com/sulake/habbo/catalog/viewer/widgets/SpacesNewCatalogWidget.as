package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_451:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         super(param1,param2);
         this.var_451 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_451)
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_451.numSelectables)
            {
               _loc4_ = this.var_451.getSelectableAt(_loc3_);
      ...
      {
         var _loc2_:int = this.var_730[this.var_572];
         var _loc3_:Offer = this.var_226[this.var_572][_loc2_];
      ...
      public function selectIndex(param1:int) : void
      {
         ...
         {
            _loc2_ = this.var_226[this.var_572][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_730[this.var_572] = (this.var_226[this.var_572] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_730[0];
         var _loc2_:int = this.var_730[1];
         var _loc3_:int = this.var_730[2];
         var _loc4_:Offer = this.var_226[0][_loc1_];
         var _loc5_:Offer = this.var_226[1][_loc2_];
         var _loc6_:Offer = this.var_226[2][_loc3_];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_441 || _loc1_.pricingModel == Offer.const_442))
            {
               continue;
            }
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_63 || _loc2_.productType == ProductTypeEnum.const_77))
            {
               continue;
            }
            ...
            while(this.var_226.length < this._groupNames.length)
            {
               this.var_226.push(new Array());
            }
            switch(_loc4_)
            {
               case "floor":
                  (this.var_226[_loc5_] as Array).push(_loc1_);
                  break;
               case "wallpaper":
                  (this.var_226[_loc5_] as Array).push(_loc1_);
                  break;
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_451.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_226[this.var_572],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_730[this.var_572];
