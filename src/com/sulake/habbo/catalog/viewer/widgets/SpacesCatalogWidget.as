package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var _floorType:String = "ErrorEvent";
      ...
      private var var_1615:String = "ErrorEvent";
      ...
      private var var_1614:String = "1.1";
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1073 = this.parseElements(_loc2_.floors.pattern);
         this.var_1318 = this.parseElements(_loc2_.walls.pattern);
         this.var_1316 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_1073)
                  {
                     _loc11_ = this.var_1073[_loc10_];
                     if(this.var_704.indexOf(_loc10_) == -1)
                     {
                        this.var_704.push(_loc10_);
                        this.var_1319.push(_loc3_);
                     }
                  }
                  break;
               case "wallpaper":
                  if(this.var_1318[_loc8_] != null)
                  {
                     this.var_877.push(_loc8_);
         ...
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1615,this.var_1614,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1317[this.var_481];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1615);
               }
               break;
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1319[this.var_483];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this._landscapeOffers[this.var_486];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1614);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_704[this.var_483];
         var _loc3_:Array = this.var_1073[_loc2_];
         if(_loc3_ != null && this.var_484 >= 0)
         {
            _loc11_ = _loc3_[this.var_484];
            if(_loc11_ != null)
            {
               this._floorType = _loc11_;
            }
         }
         var _loc4_:Offer = this.var_1319[this.var_483];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_877[this.var_481];
         var _loc6_:Array = this.var_1318[_loc5_];
         if(_loc6_ != null && this.var_485 >= 0)
         {
            _loc13_ = _loc6_[this.var_485];
            if(_loc13_ != null)
            {
               this.var_1615 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1317[this.var_481];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_876[this.var_486];
         var _loc9_:Array = this.var_1316[_loc8_];
         if(_loc9_ != null && this.var_482 >= 0)
         {
            _loc15_ = _loc9_[this.var_482];
            if(_loc15_ != null)
            {
               this.var_1614 = _loc15_;
            }
         }
         var _loc10_:Offer = this._landscapeOffers[this.var_486];
         if(_loc10_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_111:
               ...
               if(this.var_483 < 0)
               {
                  this.var_483 = this.var_704.length - 1;
               }
               if(this.var_483 >= this.var_704.length)
               {
                  this.var_483 = 0;
               }
               this.var_484 = 0;
               this.var_1072 = 0;
               _loc5_ = this.var_704[this.var_483];
               _loc6_ = this.var_1073[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_1072 = _loc6_.length;
               }
            ...
            case const_236:
               ...
               if(this.var_481 < 0)
               {
                  this.var_481 = this.var_877.length - 1;
               }
               if(this.var_481 == this.var_877.length)
               {
                  this.var_481 = 0;
               }
               this.var_485 = 0;
               this.var_1075 = 0;
               _loc7_ = this.var_877[this.var_481];
               _loc8_ = this.var_1318[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_1075 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_486 < 0)
               {
                  this.var_486 = this.var_876.length - 1;
               }
               if(this.var_486 >= this.var_876.length)
               {
                  this.var_486 = 0;
               }
               this.var_482 = 0;
               this.var_1074 = 0;
               _loc9_ = this.var_876[this.var_486];
               _loc10_ = this.var_1316[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_1074 = _loc10_.length;
               }
