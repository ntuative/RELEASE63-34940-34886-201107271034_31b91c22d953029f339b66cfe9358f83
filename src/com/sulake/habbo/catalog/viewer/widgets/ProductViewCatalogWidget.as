package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1510:IScrollbarWindow;
      
      protected var var_1789:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1005 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         ...
         if(this.var_200 != null)
         {
            ...
            this.var_536 = this.var_200.findChildByName("room_canvas") as IDisplayObjectWrapper;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1005.text = _loc4_;
         this.var_1238.text = _loc5_;
         this.var_1005.height = this.var_1005.textHeight + 5;
         this.var_1238.y = this.var_1005.y + this.var_1005.height;
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_493:
                  ...
                  if(this.var_537 != null)
                  {
                     ...
                     _loc11_.populateItemGrid(this.var_537,this.var_1510,this.var_1789);
               ...
               case Offer.const_442:
                  ...
                  if(this.var_200 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_77 || _loc9_.productType == ProductTypeEnum.const_63 || _loc9_.productType == ProductTypeEnum.const_198)
                     {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_374,AvatarAction.const_544);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2512)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_98 != null && true)
         {
            ...
            this.var_98.x = this.var_1875.x;
            this.var_98.y = this.var_1875.y;
            if(param3 != null)
            {
