package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      private var var_469:IButtonWindow;
      ...
      {
         super(param1);
         this.var_469 = _window.findChildByName("listen") as IButtonWindow;
         this.var_1186 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         if(this.var_469 != null)
         {
            this.var_469.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
            this.var_469.disable();
         }
         this.var_1185 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
      ...
      override public function dispose() : void
      {
         if(this.var_469 != null)
         {
            this.var_469.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
         }
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            ...
            this._soundManager.musicController.playSong(this.var_971,HabboMusicPrioritiesEnum.const_222,15,40,0.5,2);
         }
      }
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1186.text = _loc8_;
            }
         }
         else if(this.var_1186 != null)
         {
            this.var_1186.text = "";
         }
         if(this.var_469 != null)
