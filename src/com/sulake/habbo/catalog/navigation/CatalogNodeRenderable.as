package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1464:Number = 4285716709;
      ...
      private var var_3087:IWindowContainer;
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1953;
            }
         }
      }
      ...
      {
         this.var_63 = navigator.catalog.windowManager.buildFromXML(var_1469) as IItemListWindow;
         if(this.var_63 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1468) as IWindowContainer;
         }
         else
         {
