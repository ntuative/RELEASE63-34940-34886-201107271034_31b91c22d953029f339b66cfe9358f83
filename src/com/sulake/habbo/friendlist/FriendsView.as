package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_2271:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2606:IContainerButtonWindow;
      
      private var var_2605:IContainerButtonWindow;
      
      private var var_2607:IContainerButtonWindow;
      
      private var var_2293:IContainerButtonWindow;
      
      private var var_63:IItemListWindow;
      
      private var var_618:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_618 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2606 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2605 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2607 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2293 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2606,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2605,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2607,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2293,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_618.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_618.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_618.closePopup();
         }
