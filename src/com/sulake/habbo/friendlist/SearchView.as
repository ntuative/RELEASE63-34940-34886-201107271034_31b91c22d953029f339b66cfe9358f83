package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         this.var_887 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_887.procedure = this.onSearchInput;
         this.var_887.addEventListener(WindowKeyboardEvent.const_192,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_63.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_463,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_618.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_618.showPopup(this._friendList.view.mainWindow,IWindowContainer(param2));
         }
