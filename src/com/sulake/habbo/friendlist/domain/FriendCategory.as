package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         var _loc4_:* = null;
         if(this.var_245.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         while(_loc3_ < this.var_245.length)
         {
            ...
            {
               this.var_245.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean = false) : int
      {
         var _loc4_:* = null;
         var _loc3_:int = 0;
         for each(_loc4_ in this.var_245)
         {
      ...
      public function removeFriend(param1:int) : Friend
      {
         ...
         if(_loc2_ != null)
         {
            Util.remove(this.var_245,_loc2_);
            return _loc2_;
         }
         return null;
      }
      ...
      {
         if(this.var_997 >= this.getPageCount())
         {
            this.var_997 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_245.length / const_446);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_997 * const_446;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_997 + 1) * const_446,this.var_245.length);
      }
