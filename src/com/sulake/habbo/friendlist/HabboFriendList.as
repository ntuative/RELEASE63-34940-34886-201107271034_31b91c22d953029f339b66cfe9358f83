package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_888:ISessionDataManager;
      
      private var var_2873:FriendListLookAndFeel;
      
      private var var_451:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_2086:OpenedToWebPopup;
      ...
      private var var_2087:AvatarSearchResults;
      ...
      {
         this.var_2873 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_119 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_2087 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_712.stop();
            this.var_712.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_712 = null;
         }
         ...
         if(this.var_888)
         {
            this.var_888.release(new IIDSessionDataManager());
            this.var_888 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_2086 = new OpenedToWebPopup(this);
         }
         this.var_2086.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_463);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_344,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_608.createAvatarImage(param1,AvatarScaleType.const_113,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         this.var_1011 = param2 as IHabboNotifications;
      ...
      {
         this.var_888 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_119.addCategory(new FriendCategory(FriendCategory.const_1338,this.getText("friendlist.friends")));
         this.var_119.addCategory(new FriendCategory(FriendCategory.const_453,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_119.addFriend(new Friend(_loc4_));
         }
         this.var_451 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_712)
         {
            this.var_712 = new Timer(120000);
            this.var_712.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_712.start();
         }
         ...
         {
            _loc5_ = this.var_119.findCategory(FriendCategory.const_453);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_451.findTab(FriendListTab.const_87).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_451.findTab(FriendListTab.const_87);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_2087.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_451.findTab(FriendListTab.const_87);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_451.findTab(FriendListTab.const_87);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_888 || !this.var_120)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_888.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_43))
         {
            _loc2_ = this.var_120.vipLimit;
         }
         else if(this.var_888.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_35))
         {
