package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureData implements IAvatarImageListener
   {
      ...
      public static const const_1858:String = "U";
      
      public static const const_557:String = "h";
      
      public static const const_635:String = "std";
      ...
      public static const const_303:String = "ha";
      ...
      private var var_1708:HabboAvatarEditor;
      ...
      public function getColourIds(param1:String) : Array
      {
         ...
         return [this.var_1708.getDefaultColour(param1)];
      }
      ...
      public function updateView() : void
      {
         ...
         var _loc2_:IAvatarImage = this.var_1708.manager.avatarRenderManager.createAvatarImage(_loc1_,AvatarScaleType.const_62,this.gender,this);
         if(_loc2_)
         {
            _loc2_.setDirection(AvatarSetType.const_42,int(const_964));
