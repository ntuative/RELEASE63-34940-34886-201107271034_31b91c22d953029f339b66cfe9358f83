package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditorManager extends Component implements IHabboAvatarEditor
   {
      ...
      public function close(param1:uint) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorInstanceId.const_232:
               _loc2_.hide();
               break;
            case AvatarEditorInstanceId.const_459:
               _loc2_.hide();
               _loc2_.dispose();
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_1127 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
