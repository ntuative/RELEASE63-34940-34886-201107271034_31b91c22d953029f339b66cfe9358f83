package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_987:IPartColor;
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_1087 = _loc5_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1087.width,this.var_1087.height,true,0);
            _loc5_ = this.var_1087.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_987.colorTransform);
            ...
            if(this.var_987)
            {
               switch(this.var_987.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_43:
                     _loc4_.style = HabboIconType.const_1016;
                     _loc4_.visible = true;
               }
            }
            else
