package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_271)
         {
            for each(_loc2_ in this.var_271 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_951 >= 0 && this._parts.length > this.var_951)
         {
            _loc2_ = this._parts[this.var_951];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         this.deselectColorIndex(this.var_240[param2],param2);
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         if(!this.var_271 || this.var_271.length == 0)
         {
            return null;
         }
         var _loc1_:Array = this.var_271[0] as Array;
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(this.var_271.length <= param1)
         {
            return null;
         }
         return this.var_271[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return this._parts[this.var_951] as AvatarEditorGridPartItem;
      }
