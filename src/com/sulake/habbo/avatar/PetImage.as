package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_614:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_55)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1654);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_750);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_750);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_750);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_750);
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_605 = this.var_605 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_443:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1885:
                  case AvatarAction.const_2038:
                  case AvatarAction.const_1887:
                  case AvatarAction.const_1423:
                  case AvatarAction.const_1415:
                  case AvatarAction.const_2061:
      ...
      private function sortActions() : void
      {
         ...
         this.var_1655 = this._structure.sortActions(this.var_364);
         ...
         {
            this.var_916 = this._structure.getCanvasOffsets(this.var_1655,this._scale,this.var_103);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1655)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_312)
               {
                  this.var_1057 = true;
               }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1166 = _loc4_.id;
                     this.var_1733 = _loc4_.breed;
                     break;
                  }
               }
            }
