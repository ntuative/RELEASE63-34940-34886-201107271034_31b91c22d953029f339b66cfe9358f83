package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1784:AvatarSet;
      
      private var var_787:Dictionary;
      
      private var var_1783:Dictionary;
      
      private var var_1193:Matrix4x4;
      
      private var var_975:Vector3D;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc15_:* = null;
         var _loc16_:* = null;
         this.var_975 = new Vector3D(0,0,10);
         super();
         this.var_1193 = new Matrix4x4();
         this.var_787 = new Dictionary();
         this.var_1783 = new Dictionary();
         this.var_1784 = new AvatarSet(param1.avatarset[0]);
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_975.x = _loc11_;
            this.var_975.y = _loc12_;
            this.var_975.z = _loc13_;
         }
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            this.var_1783[String(_loc6_.@id)] = _loc8_;
         }
      }
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = this.var_1784.findAvatarSet(param1);
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:AvatarSet = this.var_1784.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      public function getBodyPartOfItem(param1:String, param2:String) : GeometryBodyPart
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Dictionary = this.var_1783[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:String) : Array
      {
         ...
         this.var_1193 = Matrix4x4.getYRotationMatrix(param2);
         for each(_loc7_ in _loc5_)
         {
            _loc7_.applyTransform(this.var_1193);
            _loc9_ = _loc7_.getDistance(this.var_975);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(this.hasBodyPart(param1,param2))
         {
            ...
            this.var_1193 = Matrix4x4.getYRotationMatrix(param3);
            return _loc5_.getParts(this.var_1193,this.var_975,param4);
         }
         return [];
      }
