package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      private var var_1955:AvatarDataContainer;
      
      private var var_1560:Array;
      
      private var var_1954:DirectionDataContainer;
      
      private var var_1953:ShadowDataContainer;
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         {
            this.var_1802 = String(param2.@desc);
         }
         else
         {
            this.var_1802 = this._id;
         }
         ...
         {
            this.var_1955 = new AvatarDataContainer(param2.avatar[0]);
         }
         if(param2.hasOwnProperty("canvas"))
         {
            for each(_loc4_ in param2.canvas)
            {
               this.var_1560.push(new CanvasDataContainer(_loc4_));
            }
         }
         if(param2.hasOwnProperty("direction"))
         {
            this.var_1954 = new DirectionDataContainer(param2.direction[0]);
         }
         if(param2.hasOwnProperty("shadow"))
         {
            this.var_1953 = new ShadowDataContainer(param2.shadow[0]);
         }
         if(param2.hasOwnProperty("remove"))
         {
            for each(_loc5_ in param2.remove)
            {
               this.var_1559.push(String(_loc5_.@id));
            }
         }
         ...
         if(param2.hasOwnProperty("override"))
         {
            ...
            for each(_loc7_ in param2.var_2370)
            {
               _loc8_ = _loc7_.@name;
               _loc9_ = _loc7_.@var_2370;
               this.var_675.add(_loc9_,_loc8_);
               _loc10_ = new Array();
      ...
      private function parseFrames(param1:Array, param2:XMLList, param3:AvatarStructure) : void
      {
         ...
         for each(_loc7_ in param2)
         {
            ...
            for each(_loc9_ in _loc7_.fx)
            {
               ...
               _loc11_ = new AnimationLayerData(param3,_loc9_,AnimationLayerData.const_566,_loc6_,_loc5_);
               _loc4_.push(_loc11_);
               if(_loc5_ != null)
               {
               }
      ...
      public function overridingAction(param1:String) : String
      {
         ...
         return this.var_675.getValue(param1);
      }
      ...
      public function getAnimatedBodyPartIds(param1:int, param2:String = null) : Array
      {
         ...
         for each(_loc4_ in this.getFrame(param1,param2))
         {
            ...
            else if(_loc4_.type == AnimationLayerData.const_566)
            {
      ...
      public function getLayerData(param1:int, param2:String, param3:String = null) : AnimationLayerData
      {
         ...
         for each(_loc4_ in this.getFrame(param1,param3))
         {
            ...
            if(_loc4_.type == AnimationLayerData.const_566)
            {
               for each(_loc5_ in this.var_852)
               {
      ...
      {
         return this.var_1954 != null;
      }
      
      public function hasShadowData() : Boolean
      {
         return this.var_1953 != null;
      }
