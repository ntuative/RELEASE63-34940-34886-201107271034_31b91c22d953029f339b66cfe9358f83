package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         this.var_2006 = parseInt(param2.@ink);
         this.var_2406 = String(param2.@member);
         this.var_2405 = Boolean(parseInt(param2.@directions));
         this._dx = [];
         this.var_1480 = [];
         this.var_1479 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            this.var_1479[_loc4_] = parseInt(_loc3_.@dz);
         }
      }
      ...
      {
         if(param1 < this.var_1479.length)
         {
