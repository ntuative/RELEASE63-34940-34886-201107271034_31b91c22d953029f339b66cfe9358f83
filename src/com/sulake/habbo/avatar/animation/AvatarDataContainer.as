package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_2006 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2732 = parseInt(_loc2_,16);
         this.var_2731 = parseInt(_loc3_,16);
         ...
         this.var_809 = new ColorTransform(this.var_2074,this.var_2076,this.var_2075,this._alphaMultiplier);
         this.var_1294 = this.generatePaletteMapForGrayscale(this.var_2731,this.var_2732);
      }
      ...
      {
         return this.var_1294.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1294.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1294.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1294.getValue("alphas") as Array;
      }
