package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_1197:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var var_2446:IStructureData;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         this.var_2446.appendXML(this.var_1816);
         dispatchEvent(new Event(AvatarStructureDownload.const_1197));
      }
