package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor
   {
      ...
      private var var_583:HabboAvatarEditorManager;
      
      private var var_1106:IFigureData;
      ...
      public function HabboAvatarEditor(param1:uint, param2:HabboAvatarEditorManager)
      {
         ...
         this.var_583 = param2;
         this.var_1106 = this.var_583.avatarRenderManager.getFigureData(AvatarType.const_125);
      }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         this.var_721["null"] = new FigureData(this);
         this.var_721["null"] = new FigureData(this);
         var _loc2_:FigureData = this.var_721["null"];
         var _loc3_:FigureData = this.var_721["null"];
         _loc2_.loadAvatarData(const_1667,FigureData.const_92);
         _loc3_.loadAvatarData(const_1668,FigureData.FEMALE);
         this.var_119 = new Map();
         this.var_582 = new Map();
         this.var_119.add(AvatarEditorFigureCategory.const_937,new BodyModel(this));
         this.var_119.add(AvatarEditorFigureCategory.const_55,new HeadModel(this));
         this.var_119.add(AvatarEditorFigureCategory.const_308,new TorsoModel(this));
         this.var_119.add(AvatarEditorFigureCategory.const_808,new LegsModel(this));
         ...
         this.var_582.add(AvatarEditorSideCategory.const_116,new WardrobeModel(this));
         this.var_582.add(AvatarEditorSideCategory.const_561,new ClubPromoModel(this));
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         if(this.var_893 != param3)
         {
            this.var_893 = param3;
            _loc4_ = true;
         }
         var _loc5_:FigureData = this.var_721[param2];
         if(_loc5_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_1106.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_1106.getPalette(param1);
      }
      ...
      {
         var _loc2_:ISideContentModel = this.var_582.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      {
         return this.var_721[this.var_1034];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         else
         {
            ...
            this.var_583.communication.getHabboMainConnection(null).send(_loc3_);
            _loc3_.dispose();
            _loc3_ = null;
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_893 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_583.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_583.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            _loc15_ = Boolean(_loc14_.indexOf(param2) == -1);
            if(_loc15_)
            {
               _loc21_ = this.var_583.assets.getAssetByName("removeSelection") as BitmapDataAsset;
               if(_loc21_)
               {
                  _loc22_ = (_loc21_.content as BitmapData).clone();
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1417.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1858)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_893 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1417.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      {
         return this.var_583.configuration.getBoolean("avatareditor.allowclubtryout",false);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_893 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_582.getValue(AvatarEditorSideCategory.const_116);
      }
