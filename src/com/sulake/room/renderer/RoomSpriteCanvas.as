package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1686:Number = 50;
      ...
      private var var_305:BitmapDataCache;
      
      private var var_736:RoomObjectCache;
      
      private var var_594:Array;
      
      private var var_735:Array;
      
      private var var_1675:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2934:Number = -1.0E7;
      
      private var var_2940:Number = -1.0E7;
      ...
      private var var_3111:Boolean = false;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_304 = new Sprite();
         this.var_304.mouseEnabled = false;
         this.var_117 = new Sprite();
         this.var_117.name = "canvas";
         this.var_117.mouseEnabled = false;
         this.var_304.addChild(this.var_117);
         ...
         this.var_305 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
         ...
         this.var_736 = new RoomObjectCache(_loc6_);
         this.var_809 = new ColorTransform();
      ...
      {
         this.var_591.x -= param1 - this.var_731;
         this.var_731 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_591.y -= param1 - this.var_733;
         this.var_733 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_1018 = true;
            if(this.var_164 != null && !this.var_304.contains(this.var_164))
            {
               this.var_304.addChild(this.var_164);
         ...
         else if(!param1 && this.var_1018)
         {
            ...
            if(this.var_164 != null && this.var_304.contains(this.var_164))
            {
               this.var_304.removeChild(this.var_164);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_304.numChildren > 0)
            {
               this.var_304.removeChildAt(0);
            }
            this.var_304 = null;
         }
         this.var_117 = null;
      ...
      {
         this.var_736.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_2142 = !this.var_2142;
         ...
         if(this.var_593 != this.var_2938 || this.var_592 != this.var_2937)
         {
            _loc8_ = true;
         }
         if(this.var_117.x != this.var_731 || this.var_117.y != this.var_733)
         {
            this.var_117.x = this.var_731;
         ...
         this.var_2938 = this.var_593;
         this.var_2937 = this.var_592;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1674 > 0)
         {
            _loc2_ = param1 - this.var_1674;
            if(_loc2_ > const_1164 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2936 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_904;
               if(this.var_904 == const_393 + 1)
               {
                  this.var_534 = _loc2_;
                  this.var_2141 = this.var_2935;
               }
               else if(this.var_904 > const_393 + 1)
               {
                  _loc3_ = Number(this.var_904 - const_393);
                  this.var_534 = this.var_534 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_2141 = this.var_2141 * (_loc3_ - 1) / _loc3_ + Number(this.var_2935) / _loc3_;
                  if(this.var_904 > const_393 + const_1687)
                  {
                     this.var_904 = const_393;
                     if(!this.var_1368 && this.var_534 > const_1164)
                     {
                        this.var_1368 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1368 && this.var_534 < const_1686)
                     {
                        this.var_1368 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_736.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_736.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_2142 && this.var_1368);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_731;
                  ...
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     _loc17_.x = _loc19_ - this.var_731;
      ...
      {
         if(param1 < this.var_593 && param1 + param3 >= 0 && (param2 < this.var_592 && param2 + param4 >= 0))
         {
            if(!this.var_3111)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         for each(_loc5_ in this.var_2939)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_1120)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(param2 < 0 || param2 >= this.var_1120)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_905 || this.var_905 == 0)
         {
            _loc4_ = this.var_1120 - 1;
            while(_loc4_ >= param1)
            {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_305.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_305.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_305.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            if(name.length > 0)
            {
               this.var_305.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_809.redMultiplier = tR;
            this.var_809.greenMultiplier = tG;
            this.var_809.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_809);
            if(name.length > 0)
            {
               this.var_305.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_731;
         param2 -= this.var_733;
         this.var_591.x = param1;
         this.var_591.y = param2;
         if(this.var_1367 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_2144;
         }
         this.var_2144 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1367;
         return this.var_2144;
      }
      ...
      private function createMouseEvent(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : RoomSpriteMouseEvent
      {
         ...
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_2143,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_734.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_734.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2934 || param2 != this.var_2940)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_734.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_734.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_416 != null && param1 != null)
         {
            this.var_416.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_416 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_416.getKey(_loc1_);
            _loc3_ = this.var_416.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1675.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1367 == 0)
         {
            this.checkMouseHits(this.var_591.x,this.var_591.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1367 = 0;
         ++this.var_2143;
      }
