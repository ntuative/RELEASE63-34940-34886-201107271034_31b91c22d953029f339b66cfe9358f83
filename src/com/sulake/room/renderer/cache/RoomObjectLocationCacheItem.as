package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1772 || param1.getUpdateID() != this.var_2775)
         {
            this.var_2775 = param1.getUpdateID();
            if(param2.updateId != this.var_1772 || _loc4_.x != this.var_1310.x || _loc4_.y != this.var_1310.y || _loc4_.z != this.var_1310.z)
            {
               this.var_1772 = param2.updateId;
               this.var_1310.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_2774 = _loc3_;
         if(_loc3_)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  this.var_402.assign(_loc5_);
                  if(_loc8_ != null)
                  {
                     this.var_402.z = _loc8_.z;
                  }
               }
               else
               {
            ...
            this.var_402.x = Math.round(this.var_402.x);
            this.var_402.y = Math.round(this.var_402.y);
         }
         return this.var_402;
      }
   }
