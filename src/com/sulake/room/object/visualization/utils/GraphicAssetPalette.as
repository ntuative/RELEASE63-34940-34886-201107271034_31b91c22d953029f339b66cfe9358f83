package com.sulake.room.object.visualization.utils
{
   ...
   public class GraphicAssetPalette
   {
      ...
      private static var name_4:Array = [];
      ...
      public function GraphicAssetPalette(param1:ByteArray, param2:int, param3:int)
      {
         ...
         while(param1.bytesAvailable >= 3)
         {
            ...
            this.var_1004.push(_loc7_);
         }
         while(this.var_1004.length < 256)
         {
            this.var_1004.push(0);
         }
         while(true)
         {
            name_4.push(0);
      ...
      public function colorizeBitmap(param1:BitmapData) : void
      {
         ...
         param1.paletteMap(param1,param1.rect,new Point(0,0),name_4,this.var_1004,name_4,name_4);
