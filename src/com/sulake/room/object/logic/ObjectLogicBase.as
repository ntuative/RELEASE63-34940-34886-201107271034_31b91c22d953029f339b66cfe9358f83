package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_429:IRoomObjectController;
      ...
      public function set object(param1:IRoomObjectController) : void
      {
         ...
         {
            this.var_429.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_429 = param1;
            this.var_429.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_429 != null)
            {
               this.var_429.setLocation(param1.loc);
               this.var_429.setDirection(param1.dir);
            }
         }
      }
